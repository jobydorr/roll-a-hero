...
window.DM_CAMPAIGN = {
  ...
  "docs": [
    ...
    },
    {
      ...
      "id": "enc-ganny",
      "type": "encounter",
      "title": "The thing in Ganny's preserves — and what it brought",
      "parent": "f-iftime",
      "order": 40,
      "rev": 8,
      "tags": [
      ...
      "leadsTo": [],
      "fields": {
        "setup": "[[loc-ganny|Ganny Marle]] asks for this herself, out on the fairground at dusk — see [[b-comm-dusk|THE COMMISSION beat 2]]. Her pitch is a pest problem and nothing more: six jars gone in a fortnight, the lids taken off and set aside neatly rather than broken, and other things besides that she does not itemize.\n\nShe takes them down, lights one lamp, moves a shelf, and shows them the real hole at the back of the cellar — the first thing all evening she has not made a joke about.\n\nBEFORE ANYTHING COMES THROUGH, LET THEM LOOK AT IT. Brick dust on the floor underneath. Fresh scrapes in the mortar all round the rim, dozens of them, and all of them small. Somebody has been working at this from the other side for a long time. No roll — describe it and let the party work out what it means.\n\nThen the lamp, and the dark, and the waiting. Twenty minutes of game time.",
        ...
        "tactics": "THE KITS COME FIRST, one at a time, and for a minute it is exactly the small frightened thing Ganny described. Let the party believe that is the encounter. Let somebody try to catch one.\n\nTHEN THE DOOR GETS MADE, AND THIS IS THE BEAT THE WHOLE EVENING IS BUILT ON. Slow down and describe it in order, because everything the party learns tonight they learn by watching it happen:\n· One kit takes a knot of something out of a rag — wrong-colored, faintly fizzing, unpleasant to look at.\n· It presses the knot into a socket in a small object it has been carrying.\n· It holds the object against the brickwork beside the hole.\n· The wall does not break. It goes soft, the way a crease goes soft, and then it goes wide.\n· And what comes through is not knee-high.\n\nTHE KIT DROPS THE OBJECT. The ogre shoves past it and the object goes onto the floor, and the kit does not go back for it, because there is now an ogre between the kit and everything. Say it out loud when it lands. The party is meant to see it fall.\n\nTHE KITS STILL DO NOT FIGHT, even now. They scatter, they hide badly, they bolt for the hole, and any one of them can still be taken in a coat or a sack. A party that is gentle with one has it almost tame inside the hour, which children will find far more interesting than a corpse.\n\nTHE OGRE IS SLOW, LOUD AND BENT OVER. It goes for whoever is nearest and it does not think. It is not cruel and it is not clever. It came for food.\n\nIT CAN BE DRIVEN BACK. If it is badly hurt it goes for the hole rather than the stairs, and a party that would rather herd it than kill it should be allowed to win that way. The object stays on the floor either way.",
        "reward": "THE OBJECT, off the floor. It is small enough for a knee-high thing to carry, it was plainly made by hands that had tools, and it has been used a great deal — worn smooth where it is held. There is a socket in it that the salt goes into, so anybody who watched the kit work knows how it is used even though nobody knows what it is.\n\n⚠ WHAT IT IS, AND WHERE IT CAME FROM, IS DELIBERATELY OPEN — JOBY'S, TO SETTLE LATER. What the document does commit to is that IT IS NOT GOBLIN-MADE, which is the actual hook: the question in the party's hands is not what does this do, it is who gave this to them. Do not answer that at the table. Let the players carry it.\n➕ THE CANDIDATE ON THE BACK BURNER, not canon and not to be leaked: a wizard's tower that was FOLDED AWAY, used for a long time afterward, and since abandoned. Creatures in the zones have been getting sunsalt and other worked things out of it, peacefully or otherwise. If the party ever reaches that tower, this object is where the thread started.\n\nTHE HOARD, behind a loose stone in the wall, and they find it whichever way the night went. A magpie's pile of shiny nothing: buttons, three spoons, a bootlace, a brass curtain ring, and a great deal of broken glass.\n\nAND TWO THINGS IN IT THAT DO NOT BELONG.\n\nThe first is something that was on a person at the fairground this morning, and that the party can recognize: a garland ribbon in the Draw's colors, a child's shoe, a lamplighter's brass key. It did not come from a cellar three streets away, which means this hole and the tear at the foot of the Hearthspire open into the same place.\n\nThe second is a jar of preserves that is not Ganny's, with a label in somebody else's handwriting. THIS IS THE OTHER-CELLARS CLUE and it is the only one in the room, so put it where they will find it. A goblin came in through a hole, took a jar out of a different cellar in this city, and brought it back here — which means the holes join up.\n\nWHAT GANNY DOES ABOUT THAT JAR, and play it badly on purpose. She does not confess and she is not going to mention Red Flag tonight or for a long time yet. But she is eighty and she is not a professional, so let her deflect visibly rather than well: she answers a question nobody asked, or she says CELLARS before anyone has said there is more than one, and then she stops talking and looks at the jar. A party that leaves thinking she is a nice old lady with a pest problem has been given nothing. A party that leaves certain she knew more than she said has been given the thread, and she never had to admit a thing.",
        "terrain": "FIVE THINGS IN THIS ROOM CAN BE USED, and the party should find them rather than be handed them.\n\nTHE CEILING IS TOO LOW. The ogre cannot stand up. Everywhere except directly under the stair hatch it fights bent double: it cannot use the Sweep, and anything above its shoulder is awkward for it. Under the hatch it can straighten, and there the Sweep is live. A nine-year-old works this out inside a round and feels like a genius.\n\nTHE SHELVES — a lifetime of preserves, floor to ceiling, on old brackets. Pull a rank down on it: beat 13 or it goes prone under the glass. Afterward the floor is jam and broken glass, and anything crossing it at speed must beat 12 or fall.\n\nTHE STAIRS — six steps, narrow, and it cannot follow anybody up them. Retreat is always available and must never be framed as a failure.\n\nTHE ONE LAMP. Whoever is holding it decides what everybody can see. Knock it over and the cellar is black except for the light coming out of the hole, which is the wrong color.\n\nAND THE OBJECT ON THE FLOOR. The kit drops it when the ogre shoves past — see the tactics — and after that it is lying in the open with an eight-foot thing standing over it. Getting it is a second objective the whole table can see, and it is worth more than any damage anybody deals. So is getting Ganny up the stairs; she is eighty, she is behind the shelves, she does not scream, and she cannot get past the ogre on her own.",
        "door": "THE PARTY LEAVES THIS CELLAR KNOWING HOW TO MAKE A DOOR, and that is the prize — not the loot, not the ogre. Three ways to arrive at it, all of them in this room, and none of them can be missed.\n\n▸ KILL IT, AND SEARCH. The object is already on the floor. The ogre carries the spent knot of raw sunsalt in a fold of hide at its shoulder, wrapped in sacking, and where it has been resting the sacking has gone soft and thin and so has the brick it was set down on.\n\n▸ CATCH A KIT, AND SEARCH OR TALK TO IT. Every kit carries a pinch of the same salt tied up in a rag. If they get one calm and try to talk, it will not explain anything, because it cannot — but it will SHOW them. Give it back its pinch and the object and it will put them to a crack in the wall, make a hole the size of a coin, and be enormously pleased with itself.\n⚠ WHETHER A KIT CAN TALK IS UNDECIDED AND YOURS. It works either way: one that manages a few words badly is funnier, one that only gestures is better at teaching by demonstration.\n\n▸ LET ONE GO, AND WATCH IT LEAVE. It works the crease from three feet away with the party standing there — the pinch, the socket, the wall going soft — and it goes through and it is gone. It leaves without the object, because the object is still on the floor. Which means it will be back for it, and it means somebody on the other side is going to notice the tool is missing.\n\nWHY THEY CANNOT SIMPLY GO THROUGH TONIGHT, and this is the limiter that keeps the cellar a promise rather than a shortcut. The knot that opened the door is SPENT — it is what paid for a door that size. What is left in the world, in this room, is three pinches in three rags, and a pinch makes a hole the size of a coin. They have the method and they have the object and they do not have the fuel.\n\nAND THEY CANNOT BUY MORE. Raw sunsalt is the kind that unfolds, refining is the taming of it, and refining happens only inside a Reactor — which is canon and is on [[loc-bottles|every shelf in Dunlath]] in its refined, docile, ministry-metered form. Nobody sells the raw kind. The only places it exists are inside a tower and inside the fold, which gives the party a standing want for the rest of the act and an extremely good reason to keep this to themselves.\n\n⚠ AND IF THEY ASK WHY NOT USE THIS DOOR INSTEAD OF THE HEARTHSPIRE — they will, and there are two honest answers already in the bible. The banished zones are separate cells, so this hole and the tear at the tower do not come out in the same place, and the eleven went through that one. And the order is HOLDING the Hearthspire way open, which is a service nobody is providing in a cellar. This door is not a shortcut. It is a second front, for later, when the Surveyors have stopped being helpful.\n\nTHE COST OF THE SECRET, and do not say it out loud. A thing that opens a crease wide enough to let something big IN opens it wide enough to let something big OUT. That is exactly what happened here tonight, to an eighty-year-old woman, in a residential street."
      },
      "body": "THE POINT OF THIS, AND IT IS THE WHOLE POINT. The goblins worked out that the hole in an old woman's cellar is a way out. The party works out that it is a way in. Everything else in this encounter exists to get them to that sentence.\n\nIT MATTERS BECAUSE OF WHAT HAS COME BEFORE IT. Every door in this campaign so far has been opened FOR them. The writ was folded for them, the rooms at the Ossuary were offered, and the way at the Hearthspire gets opened as a courtesy by four polite beings who then stand there holding it. A door they worked out themselves, in a cellar, is the first thing in this campaign the party owns rather than receives. Play it as that.\n\nWHAT HAS ACTUALLY BEEN GOING ON. The jam was reconnaissance. Something small has come through a dozen times, taken something, and gone back, and nothing whatsoever has happened to it. Six jars of preserves was somebody finding out whether anyone was watching. Tonight they bring the others, they bring the tool, and they bring the thing that eats.\n\nTHIS IS A REAL FIGHT AND THERE IS NO HEALER. [[npc-tobin|Tobin]] has not joined them yet — four level-3 heroes, no cleric, one lamp, and a ceiling too low for the thing that comes through. Play it straight and lean on the no-death rule. If the whole party goes down they come round on the cellar floor with the hole shut, Ganny alive and furious, and an eight-foot thing loose somewhere in Dunlath. That is a real cost and it is not a game over.\n\nEVERYTHING HAPPENS IN THIS ROOM. Nobody chases anything across Dunlath and nobody follows anything through the hole. The cellar is the encounter.\n\n⚠ THIS IS WHERE §10 OF THE OPEN QUESTIONS GETS ANSWERED. `CAMPAIGN.md` §8 Q10 has always said that opening a portal is the single most-repeated action in the campaign and still has no ritual, no verbs and no table business. Raw sunsalt plus the object is that answer, and it is being made here on purpose rather than discovered by accident in Act Three. If the mechanic changes later, this is the document it changes in first.\n\n⚠ STILL FILED UNDER [[f-iftime|IF THERE IS TIME]] and it is not a fast piece any more. Drag it wherever you want it.",
      "fieldDefs": [
        [
          "setup",
          "Setup"
