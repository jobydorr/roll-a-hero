  ...
  "docs": [
    ...
    },
    {
      ...
      "fields": {
        ...
        "tactics": "THE KITS COME FIRST, one at a time, and for a minute it is exactly the small frightened thing Ganny described. Let the party believe that is the encounter. Let somebody try to catch one.\n\nTHEN THE HOLE OPENS. One of the kits puts something to the brickwork and the crease gives — the wall does not break, it goes soft, and then it goes wide — and what comes through is not knee-high.\n\nTHE KITS STILL DO NOT FIGHT, even now. They scatter, they hide badly, they bolt for the hole, and any one of them can still be taken in a coat or a sack. A party that is gentle with one has it almost tame inside the hour, which children will find far more interesting than a corpse.\n\nTHE OGRE IS SLOW, LOUD AND BENT OVER. It goes for whoever is nearest and it does not think. It is not cruel and it is not clever. It came for food.\n\nIT CAN BE DRIVEN BACK. If it is badly hurt it goes for the hole rather than the stairs, and a party that would rather herd it than kill it should be allowed to win that way.",
        "reward": "HOWEVER IT ENDS, THEY LEARN THE SAME THING BY A DIFFERENT VERB. Nobody can miss it and nobody rolls for it.\n\n▸ KILL IT — AND SEARCH THE BODY. In a fold of hide at its shoulder, wrapped in sacking, a knot of raw sunsalt about the size of a fist: wrong-colored, faintly fizzing, unpleasant to hold. Where it has been resting the sacking has gone soft and thin, and so has the brick it was set down on. Every kit carries a pinch of the same, tied up in a rag.\n\n▸ CATCH ONE — AND SEARCH IT, OR TALK TO IT. A caught kit has the rag with the pinch in it, and that alone is the whole answer. If they get it calm and try to talk, it will not explain anything, because it cannot — but it will SHOW them. Give it back its pinch and it will put it to a crack in the wall, make a hole the size of a coin, and be enormously pleased with itself.\n⚠ WHETHER A KIT CAN TALK IS UNDECIDED AND YOURS. It works either way: one that manages a few words badly is funnier, one that only gestures is better at teaching by demonstration.\n\n▸ LET ONE GO — AND FOLLOW IT. It does not go back through the hole. It goes up, out, and across Dunlath at a flat run over roofs and down areas, and it stops at another cellar and lets itself in through another hand-sized hole in another old wall. Which tells them two things at once: these holes are all over this city, and somebody has been leaving them alone.\n⚠ THAT IS A FORK AND IT IS YOURS. Following it ACROSS THE CITY is what is written here, and it protects the session-three cliffhanger. Following it THROUGH THE HOLE would put the party inside the fold far too early and blow up [[f-wreck|THE WAY IN]] entirely. If you want them able to go through, say so and the crease stays open instead of snapping shut.\n\nTHE HOARD, behind a loose stone in the wall, and they find it whichever way the night went. A magpie's pile of shiny nothing: buttons, three spoons, a bootlace, a brass curtain ring, and a great deal of broken glass.\n\nAnd one thing that does not belong — something that was on a person at the fairground this morning, and that the party can recognize: a garland ribbon in the Draw's colors, a child's shoe, a lamplighter's brass key. THAT OBJECT IS STILL THE POINT. It did not come from a cellar three streets away, which means this hole and the tear at the foot of the Hearthspire open into the same place.\n\nAND THEN GANNY GOES QUIET. She does not explain and she should not be made to. They leave with the object, the salt, a standing welcome to her cellar at any hour with no questions asked in either direction, as much preserve as they can carry, and the clear sense that an old woman in a good hat knew a great deal more than she said.",
        "terrain": "FOUR THINGS IN THIS ROOM CAN BE USED, and the party should find them rather than be handed them.\n\nTHE CEILING IS TOO LOW. The ogre cannot stand up. Everywhere except directly under the stair hatch it fights bent double: it cannot use the Sweep, and anything above its shoulder is awkward for it. Under the hatch it can straighten, and there the Sweep is live. A nine-year-old works this out inside a round and feels like a genius.\n\nTHE SHELVES — a lifetime of preserves, floor to ceiling, on old brackets. Pull a rank down on it: beat 13 or it goes prone under the glass. Afterward the floor is jam and broken glass, and anything crossing it at speed must beat 12 or fall.\n\nTHE STAIRS — six steps, narrow, and it cannot follow anybody up them. Retreat is always available and must never be framed as a failure.\n\nTHE ONE LAMP. Whoever is holding it decides what everybody can see. Knock it over and the cellar is black except for the light coming out of the hole, which is the wrong color.\n\nAND GANNY IS DOWN HERE, eighty years old, in a good hat, in the corner behind the shelves. She is not a hostage and she does not scream, but she cannot get past the ogre on her own. Getting her up those stairs is worth more than any damage anybody deals, and it is the moment to hand to whichever hero needs one."
      },
      "body": "THE POINT OF THIS. The hole at the back of an old woman's cellar and the tear at the foot of the Hearthspire open into the same place — and tonight is the night the far side stops being careful.\n\nWHAT HAS ACTUALLY BEEN GOING ON. The jam was reconnaissance. Something small has come through a dozen times in a fortnight, taken something, and gone back, and nothing whatsoever has happened to it. Six jars of preserves was somebody finding out whether anyone was watching. Tonight it brings the others, and it brings the thing that eats.\n\nTHIS IS A REAL FIGHT AND THERE IS NO HEALER. [[npc-tobin|Tobin]] has not joined them yet — four level-3 heroes, no cleric, one lamp, and a ceiling too low for the thing that comes through. Play it straight and lean on the no-death rule. If the whole party goes down they come round on the cellar floor with the hole shut, Ganny alive and furious, and an eight-foot thing loose somewhere in Dunlath. That is a real cost and it is not a game over.\n\n⚠ THE HOLE DOES NOT STAY OPEN, and that is deliberate. The little ones have been working the brickwork for a fortnight, and tonight they force the crease properly, which is what lets something big through. When it is over the crease snaps back to a hand's width or less, because forcing it spends slack this world does not have — Ganny will say it is smaller than it was this morning. THE PARTY'S FIRST ENTRANCE INTO THE FOLD IS STILL [[f-wreck|THE WAY IN]], and nothing here may pre-empt it.\n\nTHREE DOORS, ONE ROOM. Kill it, catch one, or let one go and follow — see the reward. All three arrive at the same fact by a different verb, so there is no wrong choice and no dead end.\n\n⚠ WHAT THIS PLANTS, AND WHAT IT DOES NOT. It plants the ingredient — raw sunsalt loosens creases, which is already canon — and it plants that these things carry it. It does NOT write the procedure for opening a portal, which CAMPAIGN.md §8 Q10 deliberately leaves open. Nobody at this table should come out of the cellar believing they now know how to make a door.\n\n⚠ THIS IS NO LONGER A FAST PIECE and it is still filed under [[f-iftime|IF THERE IS TIME]]. It is an hour, it has a real fight in it, and it belongs to the evening they go down to her house. Drag it wherever you want it.",
      "fieldDefs": [
        [
          "setup",
          "Setup"
