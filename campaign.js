  ...
  "docs": [
    ...
    },
    {
      ...
      "fields": {
        ...
        "outcome": "The party is invited, as a token of the ministry's gratitude, to be guests at [[loc-ossuary|the Keystone]] — the finest house in the city — for as long as they care to stay. A runner will bring word in the morning. Then it bows, and goes back to writing down faces.\n\nIT DOES NOT END THE AFTERNOON. There are hours of daylight left and the party is now the most famous thing in Dunlath — go on to [[b-comm-dusk|beat 2]]."
      },
    ...
    },
    {
      ...
      "id": "b-comm-2",
      "type": "beat",
      "title": "3 — A night at the Keystone",
      "parent": "f-commission",
      "order": 30,
      "rev": 6,
      "tags": [
    ...
    },
    {
      ...
      "fields": {
        ...
        "outcome": "The party learns the name of the boy from the tower's foot, from his mother, on a step, after watching him be taken — and they learn that in a building full of officials counting to eleven, not one of them said it.\n\nThe woman is [[npc-sela|Sela Orrin]]. The small boy is her surviving son, Rab. The taken one is [[npc-finch|Finch]]."
      },
    ...
    },
    {
      ...
      "id": "loc-ossuary",
      "type": "location",
      "title": "The Keystone — the ministry's hotel",
      "parent": "f-locations",
      "order": 120,
      "rev": 3,
      "tags": [
      ...
      "leadsTo": [],
      "fields": {
        "looks": "A single building thrown clean across the width of the concourse, wall to wall, standing on a row of arches big enough to take two carts abreast. Underneath the arches is where the city goes about its business — stalls in the shade of them, porters cutting through, the noise of the market coming up through the floor of the place.\n\nAbove the arches, six floors of tall windows on both faces, so that a guest looks straight down the length of Dunlath in one direction and straight back up it in the other. The piers are hollow and hold the cellars.\n\nOn the night the party stays, every window on both faces has a sunsalt lamp burning in it, which on any ordinary night is the most expensive sight in the city and on this one is obscene — and the people it is obscene in front of are directly underneath.",
        "who_is_here": "Human staff, all of them, scrupulously kind and slightly frightened of the guests. Ministry visitors, contractors, and the occasional Green Fields delegate, who are put on separate floors by a management that regards this as simple good manners rather than politics.\n\nUnderneath, in the arches, an entirely separate world that has nothing to do with the hotel and pays it no attention: a permanent market in the shade, and a great deal of traffic that has been passing through this building's legs for longer than anybody has been staying in it.",
      ...
      "body": "The Keystone earns its place by being genuinely lovely on the worst night of the city's life, which is the whole arrangement of this world reduced to one building: the occupation is warm, it is generous, it keeps its lamps lit while the street is dark, and it is very glad you came. Play the comfort straight and let the players feel however they feel about it.\n\nWHAT IT IS, PHYSICALLY, and it is worth the moment because nothing else in Dunlath is shaped like it. THE HOTEL IS A BRIDGE. It spans the concourse wall to wall on a row of enormous arches, and the whole traffic of the city goes through underneath it all day — carts, porters, hawkers, the market. The finest house in Dunlath is the thing every person in Dunlath walks under.\n\nTHE CITY CALLS IT THE SPAN. The ministry calls it the Keystone and so does the brass over the door, and nobody outside the building has used that name in conversation in living memory. Let an NPC say the Span and let a player be the one to work out they mean the same place."
    },
    {
      "schema": 1,
      "id": "loc-setsquare",
    ...
    },
    {
      ...
      "fields": {
        ...
        "voice": "Flat and practical, because she has not slept and has already cried everything she is going to cry in front of strangers. She does not plead. She states the position and waits, and it is much worse than pleading.",
        "secret": "She has no secret and she is not a plant, which the DM should hold onto, because this campaign is full of people who turn out to be something. She is exactly what she appears to be: one of the haunted, newly so, before anybody has reached her. Both Green Fields and Red Flag will come for her, and which one gets there first is worth deciding at the table rather than in advance."
      },
      "body": "Sela exists to put a face and a name on the count. She appears in [[b-comm-6|the last beat of THE COMMISSION]], on the steps, for under a minute, and she says the name of the boy the party watched be taken — [[npc-finch|Finch]] — which nobody in a building full of officials said all morning.\n\nRAB. Five. He carries a paper bird that a Surveyor folded for him at the fair, and he gives it away to a stranger with a badge because he has worked out, in the way five-year-olds do, that this is a thing he can do to help. He does it without being told and without letting go of it easily. Play the bent wing.\n\nWHERE SHE GOES. She should come back. A mother who appears once and is never seen again is a prop, and this campaign has enough of those; a mother the party keeps running into — at a Green Fields meeting, at a rope line, eventually in a dark house with a candle in the window — is the whole argument of Act One happening to one family in the background. Her arc is a standing invitation and is deliberately unscheduled."
    },
    {
      "schema": 1,
      "id": "f-locations",
    ...
    },
    {
      ...
      "fields": {
        ...
        "stock": "FOOD AND BEDS\n\n| What | Price |\n|---|---|\n| A bowl and bread | 3 cp |\n| The proper dinner, three courses, enormous | 8 cp |\n| Ale | 1 cp |\n| Good wine, by the jug | 4 cp |\n| A bed in the long room, twenty snoring strangers | 2 cp |\n| A real room with a door | 5 sp a night |\n| Travel rations bought outright, 10 days | 5 gp |\n\nTHE RATIONS ARE THE POINT: no roll, no clerk, no limit. This is where the party solves the Emporium.\n\nHIRE, and they are used to being asked.\n\n| Who | Price | Notes |\n|---|---|---|\n| A guide who knows the old workings | 1 gp a day | |\n| Two porters and a handcart | 5 sp a day | |\n| A guard company, six men, out-of-work Draw crew | 3 gp a day | Brave, sober, unemployed since Tuesday, and they will not go into a crease for any money |",
    ...
    },
    {
      ...
      "leadsTo": [],
      "fields": {
        "looks": "A sideshow run out of a house. A painted banner nailed across the whole front of the building — THE IMPOSSIBLE CORNER, in four colors, with an artist's impression that is wildly inaccurate — a lamp over the door, and a boy on a box outside doing the patter.\n\nOne penny gets you six steps down into the cellar and a look through a hand-sized hole in a partition. Behind it the corner does not meet itself: the far wall sits about two feet further off than it has any business being, and there is a draught coming out of it that smells of somewhere else. It is a good trick and it is only a trick.\n\nThe rest of the cellar is preserves — shelves of them, floor to ceiling, a lifetime of them — and one rank of those shelves stands on a hatch in the floor.\n\nBELOW: a ladder, a gallery, and then the chamber. Cut stone, prop timbers, a spoil heap, a tipping cart still on its rails, and an old hoist. The seam face at the far end is gray and dead in exactly the way the fenced pockets out on the flats are dead, and the air in front of it does not sit right.",
        "who_is_here": "[[npc-ganny|Ganny Marle]], eighty, in a good hat, apparently uninterested in what the wrinkle is and extremely interested in the coin — which is a performance she has been giving for a very long time. The boy outside is her grandson, he is on commission, and he knows nothing at all, including about the hatch.\n\nDIRECTLY ACROSS THE STREET: her neighbor has painted a bigger banner — A BETTER HOLE, HALF PRICE — and he does not have a hole. He has never had a hole. The banners have been escalating for a month and both of them are running out of wall.",
        "game": "THE LOOK · 1 cp · six steps down and a look through the partition. No roll. Everybody pays, including the party, and she will not waive it for badges.\n\nSPOTTING THE TRICK · no roll either. Any hero who says they want a proper look at it gets to work it out — the mirror, the paint, the pipe. Do not hide it and do not make them roll for it; it is far better as a thing the party catches her at.\nWHAT SHE DOES WHEN CAUGHT: she is delighted. She has been running it for years, the ministry has been down those steps and written NOVELTY on a form, and she will tell them so with some pride.\n\nTHE REAL BUSINESS IS UNDER THE FLOOR and it is not a game. It runs as [[enc-ganny|the weak point, and what came through it]], and it happens at night.\n\nTHE BANNER WAR, across the street, free, and it never resolves. He does not have a hole. He is now advertising two. Any hero who gets involved on either side has made a friend and an enemy for the rest of the campaign.",
        "hidden": "GANNY MARLE IS RED FLAG, and she is infrastructure rather than a believer. She keeps a door onto the road: the hatch under her cellar shelves opens into the old sunsalt works, which run sealed and unmapped under the whole city, and for a long time the underground has used them to move paper, parcels and occasionally people without ever setting foot in a street. She receives, and she passes on, and she makes arguments to nobody. That is deliberate — it keeps her likeable, and it leaves [[npc-hettie|Hettie Sarn]] as the one who puts the case.\n\nTHE CREASE IS A SEPARATE MATTER AND SHE KNOWS EXACTLY WHAT IT IS. Red Flag has known for a long time that the worked-out chamber holds a weak point, and has been working toward opening it, because a door into the fold is the one thing that movement actually wants and cannot get. THE GOBLINS GOT THERE FIRST, from the other side. So the thing her people have been carefully working toward is now standing open at intervals, with monsters coming out of it into her road, and she cannot tell anybody.\n\nWHY SHE HAS NOT ASKED RED FLAG FOR HELP — the question the party will ask, and three answers all true at once.\n· THERE IS NOBODY TO SEND. Red Flag is bookkeepers, couriers and candle houses. It has an eighty-year-old with a ledger and a clerk who will not draw the mace on his own belt. It does not have fighters, and a party that later joins it ought to already know that.\n· ASKING IS THE ONE THING SHE CANNOT DO. To report it is to report that her node is compromised, and a compromised node gets closed — and closing this one closes the road under half the city.\n· AND NOT TONIGHT OF ALL NIGHTS. The name went out with the criers this evening and there will be warrants by morning. Every person she might have called is going to ground on the one night she needs somebody.\n\nSO SHE ASKS THE PARTY, AND SHE IS NOT SETTLING. Four armed strangers who fought monsters in public this morning can walk into any street in this city tonight and nobody will ask them a single question. They are better than anything Red Flag could have sent her.\n\n⚠ SHE DOES NOT LET ON, AND NOT FOR A LONG TIME YET. Her cover is that she found the tunnels after the goblins came the first time and does not know what they are; the four tells that give her away are on [[enc-ganny|the encounter sheet]] and they are meant to be caught. She deflects VISIBLY BADLY rather than well, because she is eighty and not a professional. A party that leaves thinking she is a nice old lady with a pest problem has been given nothing; a party that leaves certain she knew more than she said has the thread, and she never admitted anything.\n\n⚠ UNRULED: whether the crease is still widening on its own, as against only when something opens it."
      },
      "body": "WHAT THIS PLACE ACTUALLY IS, in the order the party finds it out.\n\nFIRST, THE ATTRACTION IS A SWINDLE. THE IMPOSSIBLE CORNER is a mirror, a forced-perspective paint job and a draught off a length of pipe, and it has been for years. One penny, thank you very much. Any hero who asks for a proper look works it out, and Ganny is not remotely embarrassed to be caught — she has been caught before, by the ministry, which came down, looked, wrote NOVELTY on a form, and never came back.\n\nSECOND, THERE IS A HATCH IN THE CELLAR FLOOR, under a rank of preserve shelves. Beneath it is a ladder, and beneath that the old sunsalt works: a sealed, unmapped road running east from [[loc-olddraws|the Draws]] and up under the whole city. Her story is that she found it after the goblins came the first time and has no idea what it is.\n\nTHIRD, AND FURTHER IN, THERE IS A WEAK POINT. In a chamber where a crew once cut a seam out and took everything in it, the fabric is thin, and something on the far side has been working at it. That is where [[enc-ganny|the fight]] happens and it is not in the cellar at all.\n\nKEEP THOSE TWO THINGS APART. The tunnels are a road under a city. The crease is a hole into the fold. They have nothing to do with each other except that the road is how you get to the hole — and the party is very likely to conflate them, which is fine and which Ganny will not correct.\n\nWHY THE FAKE IS THE BEST COVER IN THE CITY. The whole street reads as two old frauds escalating at each other with banners, and the ministry's own doctrine says a wrinkle that size is a surface fault rather than a door. Nobody looks twice at a joke, and nobody investigates a thing they have already decided is impossible — and nobody at all has thought to ask what is under the floor.\n\nTHE BANNER WAR ACROSS THE STREET never stops being funny and now does real work. Her neighbor genuinely does not have a hole. He is now advertising two.\n\nWHY THIS PLACE EXISTS. It is cheap, it is weird, it is exactly the sort of thing children ask to go back to — and it quietly establishes that there is a road under Dunlath, which is the fact half of Act One is going to lean on.",
      "fieldDefs": [
        [
          "looks",
          "Looks like"
    ...
    },
    {
      ...
      "leadsTo": [],
      "fields": {
        "looks": "A line in the earth, arrow-straight, miles long, where until the morning of the lighting there was a channel dropping hundreds of feet with bridges across it and refinement towers built down its walls in tiers. All of that is inside the line now. On one side of it the grass is one green. On the other side it is another. A stream runs up to the line and does not quite meet itself on the far bank. A crow flies across and skips.\n\nIt is the newest thing in the world and it looks like it has always been there, which is the part people cannot stop staring at.",
    ...
    },
    {
      ...
      "id": "enc-ganny",
      "type": "encounter",
      "title": "Under Ganny's cellar — the weak point, and what came through it",
      "parent": "f-iftime",
      "order": 40,
      "rev": 11,
      "tags": [
      ...
      "leadsTo": [],
      "fields": {
        "setup": "[[npc-ganny|Ganny Marle]] asks for this herself, out on the fairground at dusk — see [[b-comm-dusk|THE COMMISSION beat 2]]. Her pitch is a pest problem and nothing more: six jars gone in a fortnight, the lids taken off and set aside neatly rather than broken, and other things besides that she does not itemize.\n\nTHE CELLAR IS NOT WHERE THIS HAPPENS, and that is the surprise of the evening. She takes them down the six steps, past the fake corner she charges a penny to look at, and then drags a rank of shelves off a hatch in the floor.\n\nHER COVER STORY, and she has plainly rehearsed it: the goblins broke into her cellar, and after they left the first time she went looking and found the hatch, and under it these tunnels, and she has no idea what they are. Old workings, she supposes. Nothing to do with her.\n\n⚠ LET IT BE THIN, AND LET THEM CATCH IT. She is eighty and she is not a professional, so the story does not have to hold — it only has to be said out loud. Four tells, and use as many as land:\n· There is a lamp already hanging at the bottom of the ladder, and it has been lit recently.\n· There is a path worn through the dust down there, and it is not goblin-sized.\n· She goes down without needing to see where she is putting her feet.\n· She says DON'T GO LEFT before anybody has asked whether there is a left.\nNobody has to challenge her, and she admits nothing if they do.\n\nWHAT IS ACTUALLY DOWN THERE. The old sunsalt works — canon already runs them east from [[loc-olddraws|the Draws]] and up into the city's undercroft, sealed and unmapped. A gallery, and then a chamber where a crew once cut a seam out of the rock and took everything in it.\n\nAND THE CREASE IS IN THE SEAM FACE. Describe the face before anything happens. The stone is gray and dead in exactly the way the fenced pockets out on the flats are dead. The air in front of it does not sit right. There is dust on the floor beneath it and fresh scrapes all round the rim, dozens of them, all of them small — somebody has been working at this from the other side for a long time.\n⚠ WHY THERE, and it is an inference from canon rather than a ruling: drawing raw sunsalt kills what it is drawn from, so the places that were worked hardest are the places the fabric is thinnest. Ganny's cellar is not special. The chamber under it is.\n\nThen the lamp, and the dark, and the waiting. Twenty minutes of game time.",
        "creatures": "THREE [[cr-snatch-goblin|SNATCH-GOBLIN]] KITS — knee-high, thin, very fast, and frightened of everything. Halve the sheet's hit points to 5 each. They do not want a fight and they will not start one. They want the jam and whatever else is shiny.\n\nONE OF THE THREE CARRIES THE OBJECT and is the one that opens the door. Decide which before you start so you know who is holding it when the shoving begins.\n\nAND THEN, BEHIND THEM, ONE [[cr-tear-ogre|TEAR-OGRE]] — HP 30, AC 13, +5 to hit for 1d8+3, and the Sweep. Use the sheet exactly as written.\n\nTHIS IS THE ONE THAT SHEET WAS BUILT FOR. The party watched a ring of Rectors fold a street shut around one of these at the fairground, from four hundred yards off, and never rolled a die at it. This one is eight feet away in a cellar and NO RECTOR IS COMING. Say nothing about that. Let them arrive at it themselves.",
        "tactics": "THE KITS COME FIRST, one at a time, and for a minute it is exactly the small frightened thing Ganny described. Let the party believe that is the encounter. Let somebody try to catch one.\n\nTHEN THE DOOR GETS MADE, AND THIS IS THE BEAT THE WHOLE EVENING IS BUILT ON. Slow down and describe it in order, because everything the party learns tonight they learn by watching it:\n· One kit takes a knot of something out of a rag — wrong-colored, faintly fizzing, unpleasant to look at.\n· It presses the knot into a socket in a small object it has been carrying.\n· It holds the object against the seam face.\n· The rock does not break. It goes soft, the way a crease goes soft, and then it goes wide.\n· And what comes through is not knee-high.\n\nTHE KIT DROPS THE OBJECT. The ogre shoves past it and the object goes onto the floor, and the kit does not go back for it, because there is now an ogre between the kit and everything. Say it out loud when it lands. The party is meant to see it fall.\n\nTHE KITS STILL DO NOT FIGHT, even now. They scatter, they hide badly, they bolt for the seam, and any one of them can still be taken in a coat or a sack. A party that is gentle with one has it almost tame inside the hour, which children will find far more interesting than a corpse.\n\nTHE OGRE IS SLOW, LOUD AND BENT OVER. It goes for whoever is nearest and it does not think. It is not cruel and it is not clever. It came for food.\n\nIT CAN BE DRIVEN BACK. If it is badly hurt it goes for the seam rather than the ladder, and a party that would rather herd it than kill it should be allowed to win that way. The object stays on the floor either way.\n\nIF THE PARTY IS LOSING, it goes up the ladder. That is the fail state and it is a job for tomorrow, not a defeat tonight.",
        "reward": "THE OBJECT, off the floor. Small enough for a knee-high thing to carry, plainly made by hands that had tools, and used a great deal — worn smooth where it is held. There is a socket in it that the salt goes into, so anybody who watched the kit work knows how it is held and how it is fed, and still cannot make it do anything. See the DOOR field.\n\n⚠ WHAT IT IS AND WHERE IT CAME FROM IS DELIBERATELY OPEN — JOBY'S, TO SETTLE. The document commits to one thing only: IT IS NOT GOBLIN-MADE. That is the hook — the question in the party's hands is not what it does but who gave it to them.\n➕ THE CANDIDATE, not canon and not to be leaked: a wizard's tower that was FOLDED AWAY, used for a long time afterward, and since abandoned. Creatures in the zones have been getting sunsalt and worked things out of it, peacefully or otherwise. If the party ever reaches that tower, this object is where the thread started — and it is also where they learn the part of the mechanism they are missing.\n\nTHE TUNNELS THEMSELVES, WHICH ARE WORTH MORE THAN ANY OF IT. The party now knows there is a sealed, unmapped road under Dunlath, that it comes up through a hatch in a sideshow, and that an old woman walks it in the dark without a light. Nothing about that is explained tonight.\n\nTHE HOARD, behind a loose stone in the chamber wall, found whichever way the night went. A magpie's pile of shiny nothing: buttons, three spoons, a bootlace, a brass curtain ring, and a great deal of broken glass.\n\nAND TWO THINGS IN IT THAT DO NOT BELONG.\n\nThe first is something that was on a person at the fairground this morning, and that the party can recognize: a garland ribbon in the Draw's colors, a child's shoe, a lamplighter's brass key. It came from the far side, which means this crease and the tear at the foot of the Hearthspire open into the same place.\n\nThe second is a jar of preserves that is not Ganny's, with a label in somebody else's handwriting. THIS IS THE TUNNELS CLUE, and it is the only one in the room, so put it where they will find it. The goblins have not been staying in this chamber. They have been going up OTHER hatches, in other cellars, along a road somebody keeps clear — which is exactly why Ganny needs this dealt with and cannot say so.\n\nWHAT GANNY DOES ABOUT THAT JAR, and play it badly on purpose. She does not confess and she is not mentioning Red Flag tonight or for a long time yet. But let her deflect visibly rather than well: she answers a question nobody asked, or she says CELLARS before anybody has said there is more than one, and then she stops talking and looks at the jar. A party that leaves thinking she is a nice old lady with a pest problem has been given nothing. A party that leaves certain she knew more than she said has the thread, and she never admitted a thing.",
        "terrain": "SIX THINGS IN THIS CHAMBER CAN BE USED, and the party should find them rather than be handed them.\n\nTHE ROOF IS LOW EXCEPT UNDER THE OLD HOIST. The ogre cannot stand up anywhere but the one spot where the crew used to lift. Everywhere else it fights bent double: it cannot use the Sweep, and anything above its shoulder is awkward for it. Under the hoist it can straighten, and there the Sweep is live. A nine-year-old works this out inside a round and feels like a genius.\n\nTHE PROP TIMBERS — old, dry, and holding the roof up. Pull one and bring rock down on it: beat 13 or it goes prone and half-buried.\nTHE COST, and say it before they do it: whatever the fall lands across is closed. One of the things it can close is the way back to the ladder, and another is the crease.\n\nTHE LADDER — the only way up, narrow, and the ogre cannot follow anybody onto it. Retreat is always available and must never be framed as a failure.\n\nGANNY CAME DOWN, WHICH WAS HER OWN FAULT. She is eighty, she is on the wrong side of the chamber, and she cannot get up that ladder quickly. Getting her onto it is worth more than any damage anybody deals, and it is the moment to hand to whichever hero needs one.\n\nTHE SPOIL HEAP AND THE TIPPING CART — loose rock, and a rusted cart still on its rails. The heap is high ground and bad footing; the cart can be shoved down the rails into something, once.\n\nTHE ONE LAMP, and down here there is genuinely no other light in the world except what comes out of the seam, which is the wrong color. Knock the lamp over and the fight is lit by the crease.\n\nAND THE OBJECT ON THE FLOOR. The kit drops it when the ogre shoves past — see the tactics — and after that it lies in the open with an eight-foot thing standing over it. It is a second objective the whole table can see.",
        "door": "THE PARTY LEAVES THIS CHAMBER HAVING WATCHED A DOOR BE MADE, and that is the prize — not the loot, not the ogre. Three ways to arrive at it, all of them in this room, none of them missable.\n\n▸ KILL IT, AND SEARCH. The object is already on the floor. The ogre carries the spent knot of raw sunsalt in a fold of hide at its shoulder, wrapped in sacking, and where it has been resting the sacking has gone soft and thin and so has the stone it was set down on.\n\n▸ CATCH A KIT, AND SEARCH OR TALK TO IT. Every kit carries a pinch of the same salt tied up in a rag. If they get one calm and try to talk, it will not explain anything, because it cannot — but it will SHOW them. Give it back its pinch and the object and it will put them to a crack in the rock, make a hole the size of a coin, and be enormously pleased with itself.\n⚠ WHETHER A KIT CAN TALK IS UNDECIDED AND YOURS. It works either way: one that manages a few words badly is funnier, one that only gestures is better at teaching by demonstration.\n\n▸ LET ONE GO, AND WATCH IT LEAVE. It works the seam from three feet away with the party standing there — the pinch, the socket, the rock going soft — and it goes through and it is gone. It leaves WITHOUT the object, because the object is on the floor. Which means it will be back for it, and somebody on the other side is going to notice the tool is missing.\n\n★ AND THEN IT DOES NOT WORK FOR THEM, WHICH IS THE REAL SHAPE OF THIS. They can take salt off the creatures. They can charge the object exactly the way they watched it charged — the socket takes the salt, and it plainly takes it correctly. They hold it to the rock, and something happens and then stops: a warmth, a flicker, the face going very slightly soft under their hands and then being stone again. It is not broken. The salt is not wrong. THEY are missing something, and they cannot tell what.\n\nLet them try it as many times as they like and let it fail the same way every time. Do not hint at what is missing. Do not let anybody in the fiction know either.\n\n⚠ WHAT IS MISSING IS DELIBERATELY UNWRITTEN and it is Joby's to settle. THE ANSWER ARRIVES AT THE FOLDED-AWAY TOWER, whenever the party reaches it. Until then this is a locked thing in their pocket, and that is the point of it.\n\n★★ THE PLANT PAYS OFF IN [[b-wreck-2|THE WAY IN]]. When the order opens the ground at the foot of the Hearthspire, one of the Rectors is holding something that looks VERY LIKE the thing in the party's pocket. Nobody says a word about it. Do not underline it and do not let an NPC remark on it — the players will do the work, and what they do with it is up to them.\n\nWHY THEY STILL GO TO THE HEARTHSPIRE, if they ask. Two answers already in the bible: the banished zones are separate cells, so this crease and the tear at the tower do not come out in the same place, and the eleven went through that one; and the order is HOLDING the tower's way open, which is a service nobody is providing under a cellar. This is not a shortcut. It is a second front, for later, when the Surveyors have stopped being helpful.\n\nAND THEY CANNOT SIMPLY BUY FUEL EITHER. Raw sunsalt is the kind that unfolds, refining is the taming of it, and refining happens only inside a Reactor — every bottle on [[loc-bottles|every shelf in Dunlath]] is the refined, docile, ministry-metered kind. Nobody sells the raw. It exists inside a tower and inside the fold, and nowhere else.\n\nTHE COST OF THE SECRET, and do not say it out loud. A thing that opens a crease wide enough to let something big IN opens it wide enough to let something big OUT. That is exactly what happened here tonight, under a residential street, to an eighty-year-old woman."
      },
      "body": "THE POINT OF THIS, AND IT IS THE WHOLE POINT. The goblins worked out that the weak point under the city is a way out. The party works out that it is a way in. Everything else here exists to get them to that sentence.\n\nIT MATTERS BECAUSE OF WHAT HAS COME BEFORE IT. Every door in this campaign so far has been opened FOR them — the writ folded for them, the rooms at the Keystone offered, and the way at the Hearthspire opened as a courtesy by four polite beings who then stand there holding it. A door they worked out themselves, under a cellar, is the first thing in this campaign the party owns rather than receives.\n\nTWO SEPARATE THINGS ARE DOWN THERE AND THE PARTY MUST NOT CONFUSE THEM, though they are welcome to try.\n· THE TUNNELS are the old sunsalt works, running east from the Draws and up under the whole city. They are [[npc-ganny|Ganny]]'s road, and they are Red Flag's, and they are how the underground moves without using a street. That is hers and she is not giving it up tonight.\n· THE CREASE is a weak point in the fabric down in a worked-out chamber, and it has nothing to do with the tunnels except that the tunnels are how you reach it. Red Flag has known about it and has been working toward it for a long time, because a door into the fold is the one thing that movement actually wants. THE GOBLINS GOT THERE FIRST, from the other side, and came through — which is why this is now a mess in Ganny's house that Ganny has to clean up.\n\nWHAT HAS ACTUALLY BEEN GOING ON. The jam was reconnaissance. Something small has come through a dozen times, gone up the ladder into a cellar, taken something, and gone back, and nothing whatsoever has happened to it. Six jars of preserves was somebody finding out whether anyone was watching. Tonight they bring the others, they bring the tool, and they bring the thing that eats.\n\nTHIS IS A REAL FIGHT AND THERE IS NO HEALER. [[npc-tobin|Tobin]] has not joined them yet — four level-3 heroes, no cleric, one lamp, and a roof too low for the thing that comes through. Play it straight and lean on the no-death rule. If the whole party goes down they come round on the chamber floor with the crease shut, and an eight-foot thing has gone up the ladder past an eighty-year-old woman and out into a residential street. That is a real cost and it is not a game over.\n\nEVERYTHING HAPPENS UNDERGROUND. Nobody chases anything across Dunlath and nobody goes through the crease.\n\n⚠ THIS IS WHERE §8 Q10 GETS ANSWERED. The bible has always said that opening a portal is the campaign's single most-repeated action and still has no ritual, no verbs and no table business. Raw sunsalt plus the object is that answer, and it is being made here on purpose. See the DOOR field for what the party does and does not get to keep.\n\n⚠ STILL FILED UNDER [[f-iftime|IF THERE IS TIME]] and it is not a fast piece any more. Drag it wherever you want it.",
      "fieldDefs": [
        [
          "setup",
          "Setup"
    ...
    },
    {
      ...
      "body": "The classic goblin of the bad time, come through the tear sideways — knee-high greed with a sack. It does not especially want to fight; it wants to leave with somebody. Kill-count is beside the point in a snatch-goblin fight: drop-count is the fight. (SRD goblin chassis, reworded and reskinned.)\n\nWHAT THEY CARRY, from [[enc-ganny|the chamber under Ganny's cellar]] onward: a pinch of RAW sunsalt tied up in a rag, and — one per band, not one each — a small worn object with a socket in it that the salt goes into. That is how they open a crease. It is not goblin-made and where they got it is [[enc-ganny|deliberately open]]."
    },
    {
      "schema": 1,
      "id": "cr-crease-wolf",
    ...
    },
    {
      ...
      "body": "The heavy that came through last at Lastlight, where the party does NOT fight it: the Rectors pen it far off, a street folded shut around it, which is the crowd's first lesson in what the order can do and the table's first sight of the campaign's power ceiling.\n\nAND THEN THEY MEET ONE PROPERLY, MUCH SOONER THAN PLANNED. A second one comes up out of the hole in [[enc-ganny|Ganny Marle's cellar]] on the night they go down there, in a low room, with no healer and no Rector coming. That is what this sheet was statted for and it arrives early on purpose.\n\n(SRD ogre chassis, reworded and reskinned.)"
    },
    {
      "schema": 1,
      "id": "npc-wenna",
    ...
    },
    {
      ...
      "fields": {
        "order": "1. [[b-wreck-1|The tear site]] · the held ground, the ring, and the sound coming out of it\n2. [[b-wreck-2|They open the way]] · the order opens it, and the party walks through\n3. [[b-wreck-3|Through]] · the room on the other side, and STOP\n\nThis is short on purpose. It is the last stretch of an evening, and the whole of it is getting them to the edge, over it, and one room in.",
        "setting": "[[loc-hearthspire|The Hearthspire]] on the flats below Dunlath, dead and still lit at the crown. Nobody goes into the tower — there is nothing in the tower. The ground at its foot is where the world came open, and that ground is being held by a ring of Rectors who have not moved since the day of the fair.",
        "before": "Know that the directive is simple and was given at the Set Square: eleven people are on the other side, go in and bring back who you can. Know that the order is going to open the way for them, in daylight, politely, and that this is a favor rather than a breach.\n\n★ AND KNOW THAT THE PARTY HAS PROBABLY WATCHED THIS DONE ONCE ALREADY. If they have been under [[loc-ganny|Ganny Marle's cellar]] they have seen a goblin open a crease with raw sunsalt and a small worn object, and they are carrying one of those objects, and it does not work for them. [[b-wreck-2|The opening here]] is the same procedure at a scale they cannot match. Describe it in the same order and say nothing about the resemblance.",
        "after": "Inside, in a sealed room, with the sound gone. Whatever is past it comes next, and the table should go home not knowing."
      },
      "body": "HOW TO RUN IT. Do not put an obstacle in front of this. The party has a writ, a signature, and an appointment, and every single person they meet is expecting them and glad they came. The tension is not whether they will be allowed in. It is that they are being allowed in.\n\nFORTY MINUTES, AND THEN STOP. If the session has run long this is still worth reaching, because being INSIDE is a far better place to leave the table than anywhere else in the evening. Walking through the hole is not the stop — [[b-wreck-3|the room on the other side]] is.",
      "schema": 1,
      "rev": 5,
      "leadsTo": []
    },
    ...
    },
    {
      ...
      "fields": {
        ...
        "read_aloud": "\"Four of them come in off the ring and stand around a patch of ordinary grass, and they do not hurry.\n\nOne of them opens a flat case. Inside, bedded in cloth, is a knot of something the wrong color, and it is a great deal larger than a pinch. It presses that knot into a socket in a small worn object held in its other hand — and then it crouches, and sets the object against the grass.\n\nNobody chants. Nobody makes a gesture anybody could copy. It takes about eight seconds, in the same unhurried, never-going-back-to-correct-anything way you watched one of them fold a writ in an office, and it looks like competent work.\n\nThe ground does not break. It goes soft. And then it goes wide.\n\nThere is a way. It is about the size of a door and it is not a door, and looking straight at it is difficult in a way you cannot explain to each other afterward. Through it, or past it, or under it, there is somewhere with a different light in it.\n\nAnd the sound is not faint anymore.\n\nThe one who took your names says: 'We will hold it open. We cannot hold it open indefinitely, and we cannot come with you.' It says the second part apologetically, the way you would decline an invitation you actually wanted. 'Bring back who you can.'\"",
        "env": "• THE CASE — flat, plain, and opened without ceremony. Inside, bedded in cloth, a knot of raw sunsalt far bigger than anything the party has seen, and the case holds more than one.\n★ THE OBJECT IN ITS HAND — small, worn smooth where it is held, with a socket in it. It looks VERY LIKE the thing the party took off the floor under [[loc-ganny|Ganny Marle's cellar]], and it is used in exactly the same order. Held low, never presented, never mentioned by anybody. Do not underline it.\n• THE EIGHT SECONDS — no chanting, no gesture anybody could copy, nothing anyone would call a ritual. It looks like competent work, because that is what it is.\n• THE GROUND — it does not tear and nothing snaps. It goes soft under the object, the way a crease goes soft, and then it goes wide.\n• THE WAY ITSELF — about the size of a door, standing in open air with nothing holding it up and nothing around it. Looking straight at it is difficult in a way nobody manages to describe to each other afterward.\n• THROUGH IT — a different light, warmer than this one, and plainly the wrong time of day.\n• THE DRAUGHT — air coming out of it, and it is warm, and it smells of somewhere outdoors.\n• SOUND — the voices stop being faint. That is the change everybody at the table will feel, and it is the whole argument for going in.\n• THE AUDIENCE — the cordon, the people at the rope, and the hot-nut woman have all stopped what they were doing and are watching four young people decide.",
        "if_they": "…SAY THEY HAVE ONE OF THOSE, OR PRODUCE IT — and somebody will. It is not startled and it does not take it off them. It says that is not one of ours, pleasantly, the way you would note a spelling. Then it asks where they got it, listens to the whole answer, and WRITES THE QUESTION DOWN, exactly as the escort did with the Foldwright on the walk up to the Set Square. Nothing else happens tonight.\n⚠ PROPOSED, NOT RULED — that is the ominous version. The quiet version is that nobody remarks on it at all and the party is left holding the coincidence.\n\n…ask to be taught, or to borrow one, or to buy the salt, the answer is a warm and completely unbothered no. No reason is given, because none has ever been needed, and pressing produces nothing but more courtesy.\n\n…ask what the salt is, it says sunsalt, as though that were the end of the sentence, and is mildly puzzled to be asked. It does not distinguish raw from refined out loud and will not be drawn on it.\n\n…ask how long they have, it says as long as it can manage, and it will not give a number, because it does not have one and will not invent one to comfort them.\n\n…ask how they get back, it says: the same way. Do not resolve tonight whether that is true.\n\n…ask what is in there, every one of them says the same thing in slightly different words: nobody knows. They are not hiding anything. Nobody has ever come back to tell them.\n\n…refuse, nobody makes them, nobody is angry, and the offer does not expire. The eleven stay where they are, and so does the sound.\n\n…go through, go around the table and let each player say how their hero does it.",
        "outcome": "The last hero steps through. Go on to [[b-wreck-3|the room on the other side]], which is where the evening actually ends.\n\n⚠ CHANGED: this beat used to be the stop. It is not any more — Joby wants them INSIDE at the end of the night, not standing in a doorway."
      },
      "body": "THIS IS THE CLIFFHANGER and it does not need dressing up. Four people who could not save a boy at that tower are walking into the place he went, on purpose, because they can hear him.\n\nPLAY THE OPENING AS A COURTESY, not a ritual. Nobody chants. It is four polite beings doing an eight-second piece of work for some young people they think very highly of, and the horror is entirely in how normal it is for them.\n\n★ AND IT IS THE SAME PROCEDURE THEY WATCHED A GOBLIN DO. Salt of the wrong color, out of a wrapping, pressed into a socket in a small worn object, and the object set against the ground — which does not break, but goes soft, and then goes wide. Describe it in the same order and with the same words as [[enc-ganny|the chamber under Ganny's cellar]], because the recognition is the whole point and it belongs to the players. SAY NOTHING. Let nobody in the fiction remark on it. If the table does not catch it, it lands later and costs nothing.\n\nTHE THREE THINGS THE MOLD NEEDS, and this is the rule the campaign runs on from here:\n· A CREASE THAT IS ALREADY THERE. Nobody opens a door in ordinary ground. The goblins used a worked-out seam where the fabric had worn through; the order is using the biggest wound in the world. This is why the map has particular doors in particular places and not one wherever somebody fancies.\n· RAW SUNSALT, and the amount sets the size. A pinch makes a hole the size of a coin. A knot makes something an ogre fits through. What comes out of that flat case is a great deal bigger than a pinch.\n· THE OBJECT. The party has one and it will not work for them, and nothing here explains why.\n\nHOLDING IT OPEN IS THE SEPARATE, EXPENSIVE THING, and it is what the ring is for. Opening takes eight seconds. Holding takes beings who are never doing anything else again.\n\nDO NOT LET ANYONE IN THE FICTION SAY WHAT IS ON THE OTHER SIDE. Nobody out here knows. The party finds out in [[b-wreck-3|the next beat]], which is now where the session ends.",
      "schema": 1,
      "rev": 7,
      "leadsTo": [],
      "fieldDefs": [
    ...
    },
    {
      ...
      "fields": {
        "how": "THREE WAYS IN, and the party never has to be recruited into any of them.\n\n★ FIRST AND MAIN: THE BOARD IS A REAL BOARD AND THEY WILL WALK PAST IT. It hangs in the corridor outside [[b-comm-5|Wenna's office]] — a shabby cork board on a wall of enormous polished doors, layered inches deep, every slip a petition that was passed to an office and never claimed by one. Nobody takes anything down. Until the party, nobody has ever taken anything off it either.\n\nTHEY CAN SIMPLY TAKE A SLIP. Nothing stops them and nobody is watching. [[npc-wenna|Wenna]], asked, tells them to help themselves and looks slightly guilty about it, because she has walked past that board every working day for six years.\n\nSECOND: [[npc-tobin|TOBIN'S OWN COPIES]], which are a different and more personal thing. He keeps the ones that bother him in the bottom of his satchel, which is not allowed and which he knows is not allowed. He mentions it once, on the road, as an embarrassed complaint about his own job rather than an offer, and the party asks to see them.\n\nTHIRD, AND FOREVER AFTER: A RUNNER. A boy from [[loc-clockface|the Clock Face]] finds them wherever they are, hands over a folded slip, and holds his hand out for the penny. That costs one line and works anywhere, at any time, in the middle of anything — which means a job can be put in front of the party whenever an evening needs one, with no scene required to deliver it.",
      ...
      "body": "WHY A PETITION PILE AND NOT A NOTICE BOARD — and as of 2026-09-05 it is BOTH. The jobs come from ordinary people who asked the government to deal with something and got nothing, and they hang on a wall where the party will walk past them. But that is background. The jobs are: there is a thing, go and deal with it, here is your money.\n\nTHE ONE LINE TO HAVE READY, if a runner turns up and the table wants to know what this is: \"Tobin's stack. The ones nobody was ever going to do.\" That is enough and nothing else needs saying."
    },
    {
      "schema": 1,
      "id": "unans-dog",
    ...
    },
    {
      ...
      "fields": {
        ...
        "stock": "★ THE LASTLIGHT DEBT IS FOUR BOTTLES, FREE, AND THAT IS THE WHOLE OF IT.\n· TWO ON THE FIELD, put into their hands unasked — one STITCH and one KNITBONE — because he has looked at the four of them and that is what the answers came to. See [[b-comm-dusk|THE COMMISSION beat 2]].\n· TWO MORE OF THEIR OWN CHOOSING, whenever they come up to the shop, from any shelf below except the case. He takes a complaint, never an order — see [[npc-merrit|his sheet]] for how that sets the ceiling.\nFour for the party, not four each.\n\nPRICES ARE ANCHORED TO THE BOARD. [[unans-index|A job]] pays eight to fifty gold, and the shelf is priced so that one good job buys one good bottle. Do not drift them.\n\nTHE ONES THAT MATTER. Always in stock, no permit, no questions.\n\n| Bottle | Price | What it does |\n|---|---|---|\n| Potion of Healing | 50 gp | Drink it, roll 2d4+2, get that many hit points back. Takes your action. |\n| Stitch | 65 gp | The same 2d4+2, but you POUR IT ON somebody. They do not have to drink and do not have to be awake. |\n| Knitbone | 75 gp | Heals 1d8 now and 1d8 again ten minutes later. Rewards a party that can buy itself a moment. |\n| Potion of Greater Healing | 150 gp | 4d4+4. Four behind the counter, and he looks pleased if somebody buys one. |\n| Ironhide | 60 gp | +2 Armor for one hour. |\n| Backbone | 40 gp | Ends being frightened, and you cannot be frightened again for ten minutes. |\n| Second Wind | 60 gp | Removes exhaustion, all of it. You are as rested as if you had slept. |\n| Windward | 75 gp | Breathe anything for one hour — water, smoke, bad air, whatever is in a crease. |\n| Longspeak | 5 gp | Two people drink, and for an hour each can hear the other whisper however far apart they are. |\n| Bright Eyes | 50 gp | For one minute you notice everything in a place, no roll needed. Then a headache: disadvantage on saving throws and ability checks until you next rest. NOT on attack rolls. |\n| Antitoxin | 50 gp | Advantage on saves against poison for one hour. |\n| Potion of Climbing | 75 gp | Climb speed equal to your walking speed, and advantage on climbing, for one hour. |\n| Potion of Water Breathing | 180 gp | Breathe underwater for one hour. Two in stock and they have been there a while. |\n\nTHE CHEAP SHELF, by the door. No rolls, no mechanics, and the party should buy these constantly.\n\n| Bottle | Price | What it does |\n|---|---|---|\n| Wick | 2 sp | Your fingertip burns like a candle for an hour and it does not hurt. |\n| Quiet | 3 sp | Your footsteps make no sound for ten minutes. |\n| Ballast | 1 sp | You weigh twice as much for ten minutes. |\n| Glowdrop | 2 sp | You glow, faintly and unhelpfully, for an hour. |\n| A Good Bellow | 2 sp | Your voice is enormous for ten minutes. Cannot be turned down. |\n| Fastcolor | 1 sp | Your hair is whatever color is on the label until you wash it. Twice. |\n| Hearthdrop | 3 sp | You do not feel the cold for two hours. |\n| Savor | 5 cp | Whatever you eat next tastes of whatever you said out loud. |\n| Stopnose | 1 sp | You cannot smell anything for an hour. |\n\n★ AND THE CASE. Behind the counter, floor to ceiling, closed by a grated door — and with the grate shut you cannot make out a single label. Nothing in it is on the wall, nothing in it is on any list, and the only way to see inside is for Merrit to open it, which he does when he decides to and not when he is asked.\n\nTHE LASTLIGHT FREE PICK DOES NOT REACH THE CASE. Neither does money on its own.\n\n| Bottle | Price | What it does |\n|---|---|---|\n| Second Skin | 400 gp | The next hit that would knock you out does not. Once, and then the bottle is spent. |\n| Nightwater | 300 gp | For one hour you see in pitch dark exactly as well as you see at noon. |\n| The Ninth Hundred | not for sale at any price | He made it, it is the only one there has ever been, and he will not say what it does. |\n\n⚠ THE CASE'S CONTENTS ARE PROPOSED, NOT RULED. Written in so the shelf is runnable and so there is something to want. Swap any of it freely — the three rules that matter are that it is unreadable behind the grate, that Merrit decides, and that it is a long way out of reach at this level.",
        "hidden": "Nothing sinister. It is a good shop run by good people at fair prices. The one thing worth knowing is that everything on these walls is made with refined sunsalt, which is why it works, and which is why the price of every bottle went up the same week the price of a lamp did.\n\nTHE CASE IS NOT A SECRET AND IT IS NOT LOCKED, and Merrit will tell anybody so. It is grated because he does not want a conversation about every bottle in it with every person who walks in. What is in there needs deciding on rather than pointing at, and he is the one who decides.\n\n⚠ THE NINTH HUNDRED is a hook and not an item. The painted sign outside counts the stock and has never counted that bottle. Nobody has asked him why in years."
      },
    ...
    },
    {
      ...
      "fields": {
        ...
        "who_is_here": "Clerks in green visors who take the order with total gravity, write it into a ledger, and hand it over in a paper packet sealed with wax. Nobody in this building has ever smiled at a customer and the whole city finds this hilarious.\n\n[[npc-hask|Hask Bind]] is the one the party meets, and he comes to THEM — he stands in the mud of the fairground and takes their order for four sweets the Vault means to name after them. See [[b-comm-dusk|THE COMMISSION beat 2]].",
        "stock": "A copper a packet unless marked. The printed list on the counter has numbers and no descriptions, so ordering is a gamble unless somebody tells you what is good — and everybody in Dunlath has an opinion about the numbers.\n\nWHAT COMES BACK, if they order blind. Roll a d8, or just pick.\n\n| d8 | What comes back |\n|---|---|\n| 1 | Glass buttons. Hard, sour, and they last an hour. Universally agreed to be the best value in the city. |\n| 2 | Something that fizzes so violently that children hold their mouths open to show each other. |\n| 3 | A single enormous humbug. One. It is the size of an egg and it costs the same as everything else. |\n| 4 | Salt liquorice. Nobody likes this. Everybody orders it once. |\n| 5 | Honeycomb shards, and the packet is mostly dust, and the dust is the good part. |\n| 6 | Little sugar animals, and no two packets have the same animals in them. |\n| 7 | Something faintly warm that stays faintly warm. Nobody will explain it. It is delicious. |\n| 8 | A packet of thirty tiny different things, which is the one to order if the table cannot decide. |\n\nNAMED DRAWERS, the ones people ask for.\n\n| Drawer | Price | What it is |\n|---|---|---|\n| 12 | 1 cp | The glass buttons. What a local orders. |\n| 88 | 2 cp | The fizzing ones. What a nine-year-old orders. |\n| 201 | 5 cp | A packet you are not allowed to open in the shop. The clerks are firm about this and will not say why. |\n| 400 | 4 gp | More than a week's wages, and the clerks will not say what is in it. Not dangerous, not magic, and genuinely worth the money. |\n| 401–404 | 1 cp | The party's own, once [[b-comm-dusk|Hask has taken the order]] — one per hero, names on the brass, holding what that player invented. |",
        "hidden": "⚠ DRAWER 400 IS STILL DELIBERATELY UNDECIDED, which is where Joby had it and where it is better. It is the one everybody asks about and nobody has bought from in years, because it costs more than a week's wages and the clerks will not say what is in it. It is not dangerous, it is not magic, and it is genuinely worth the money. Somebody will eventually spend the money — decide then, at the table, and make it worth it.\n\nDRAWERS 401 TO 404 ARE THE PARTY'S, and they do not exist until [[b-comm-dusk|Hask takes the order]]. One per hero, names on the brass plate, each holding the sweet that hero invented — a flavor, a texture and a name, in the player's own words. Write those down verbatim. They are player-authored and they outrank anything in this repo.\n\nTHEY ARE A PLAQUE RATHER THAN A LOCKER. A nine-year-old's name on a wall in the city, there any time they walk in. If the party later works out that a private numbered drawer behind a brass grille in a building run like a bank would be a very good place to leave something, that is them being clever and not a feature anybody designed for them."
      },
    ...
    },
    {
      ...
      "fields": {
        ...
        "if_they": "…ask [[npc-merrit|Merrit]] for a named potion, he does not take orders and is not rude about it. He asks what they want to be able to DO, and then sends the boy up the ladder. Whatever comes down is the right bottle, and he is never wrong — which means the ceiling on this gift sits wherever you set it, in character, in the moment.\n\n…try to pay any of the three, none of them takes it. Merrit is insulted. [[npc-hask|Hask]] states that the transaction has already been recorded. Ganny says she is paying THEM, and that they have not agreed to anything yet.\n\n…ask [[npc-hask|Hask]] what on earth he is talking about, he explains it as though it were self-evident. The Vault has four hundred drawers. It intends to have four hundred and four. He is here for the contents.\n\n…give him something ridiculous, he writes it down verbatim and reads it back with total gravity, and that is the entire joke. Do not let him smile and do not let him editorialize. The worse the answer, the straighter the delivery.\n\n…ask what is in Drawer 400, he says he is not able to discuss the contents of a drawer. Asked again, the same sentence with the same intonation. It is policy rather than mystery and he would say so if anybody asked him the right way.\n\n…cannot think of anything, he waits, and he will wait a very long time. If they are genuinely stuck he offers to call again tomorrow, and means it.\n\n…ask whether they are being paid for this, no. They are being given a drawer, which he plainly considers the better end of the bargain.\n\n…ask for something to eat right now, he has samples in the case and hands them round while he writes.\n\n…ask [[npc-ganny|Ganny]] what the thing in her cellar is, she says that if she knew what it was she would not need them, which is true.\n\n…ask Ganny why not the ministry, she says that a ministry matter in your cellar means you do not have a cellar. Every adult on this field would say the same, and it is the most ordinary sentence anybody says to them all day.\n\n…ask Ganny why THEM — this is the good question and the real answer is on [[loc-ganny|her location sheet]]. What she gives them is the plain half of it: four armed strangers who fought monsters in public this morning can walk into any street in this city tonight without one person asking them why.\n\n…refuse all three, nothing is withdrawn and nobody is offended. It is all still there tomorrow.\n\n…go looking for more of this, let them have it. Half the field wants to give them something, and most of it is a garland, a drink, or a hand on the shoulder.",
        "outcome": "THREE STANDING OFFERS, and only one of them has an hour attached.\n\n[[loc-bottles|NINE HUNDRED BOTTLES]] — a STITCH and a KNITBONE in their hands now, and TWO MORE of their own choosing waiting at the shop. Four free bottles in total, for the party. [[npc-merrit|Merrit Quist]] will not take an order, only a complaint.\n\n[[loc-sugar|THE SUGAR VAULT]] — four sweets the players invented, going into four new drawers with their names on the brass. WRITE DOWN EXACTLY WHAT THEY SAID. See [[npc-hask|Hask Bind]].\n\n[[npc-ganny|GANNY MARLE]] — tonight, in her cellar. It runs as [[enc-ganny|the thing in Ganny's preserves]] — an hour, with a real fight in it — and it is the only thing on this field that expires.\n\nTHEN THE BELL. The crier comes up the road with a paper and a name, exactly as written at the end of [[b-last-5|LASTLIGHT beat 5]]. Run it here if it has not been run already.\n\nAnd then [[b-comm-2|the Keystone]], whenever they finally go up."
      }
    },
    {
      "schema": 1,
      ...
      "leadsTo": [],
      "fieldDefs": null,
      "body": "Proprietor of [[loc-bottles|Nine Hundred Bottles]]. He enters the party's life on the field at Lastlight in [[b-comm-dusk|THE COMMISSION beat 2]], working, with a crate on his hip.\n\nHE IS NOT A REWARD-GIVER, and the gift lands far better if the party has watched him do it for three other people first. He came down because there are hundreds of injured people on a field and he owns nine hundred bottles. They are one stop on a long afternoon.\n\nHOW HE WORKS, AND IT NEVER CHANGES. Three questions — where does it hurt, when did it start, did anything touch you — and then he produces one specific bottle. He does not sell from a list and he does not take orders. A hero who names a potion gets asked what they want to be able to do instead, and then the boy goes up the ladder.\n\n★ WHAT HE ACTUALLY PUTS IN THEIR HANDS ON THE FIELD, unasked and before anybody offers him anything: ONE KNITBONE and ONE STITCH. Not one each — two, for the party. He does it because he has looked at the four of them and that is what the answers came to, and he is never wrong. It matters that they leave the fairground holding these: they may well go under [[loc-ganny|Ganny Marle's cellar]] tonight, and [[npc-tobin|Tobin]] has not joined them yet, so those two bottles are the only healing in the party.\n\nAND TWO MORE WAITING AT THE SHOP, of their own choosing, whenever they come up for them. FOUR FREE BOTTLES IS THE WHOLE DEBT — four for the party, not four each — and he considers it settled after that, though he will always be pleased to see them.\n\n⚠ THAT OFFER IS ALSO THE DIAL. Because Merrit answers a need rather than an order, the ceiling sits wherever you put it, in character, in the moment — and a man who is never wrong can decline to hand a nine-year-old something enormous without anybody at the table feeling refused. THE FREE PICK REACHES THE GP SHELF. It does not reach the case.\n\nTHE BOY WITH THE LADDER is worth keeping. He carries it everywhere, including places with no shelves in them, and he will race anybody.",
      "fields": {
    ...
    },
    {
      ...
      "leadsTo": [],
      "fieldDefs": null,
      "body": "A counter clerk at [[loc-sugar|the Sugar Vault]], and the whole joke of that shop delivered by one man. He finds the party on the field in [[b-comm-dusk|THE COMMISSION beat 2]] — not to give them anything, but because he is at work and he needs answers.\n\nWHAT HE IS ACTUALLY DOING. The Vault intends to name four sweets after them and add four drawers to the wall, and Hask has come to take the order. He requires, from each hero, a FLAVOR, a TEXTURE and a NAME. He writes down exactly what they say, and then he reads it back to confirm.\n\nTHAT IS THE WHOLE SCENE, AND IT BELONGS TO THE PLAYERS. Three blanks each. Write down what they actually say, word for word — it is player-authored and it outranks anything invented in this repo. Two nine-year-olds will take a great deal longer over three blanks than three blanks warrant, and enjoy every second of it.\n\nPLAY HIM ABSOLUTELY STRAIGHT. He is not being funny and he does not know that he is. He is conducting a formal consultation in a foot of mud on the worst afternoon this city has ever had, because the order has to be taken and he is the one who came to take it. NEVER LET HIM CRACK — however ridiculous the answers get, he writes them down and reads them back flatly and without comment. The children will do all of the work.\n\nWHY THE VAULT IS DOING THIS AT ALL, and nobody ever has to say it out loud: Dunlath reopened its food stalls within the hour, and a confectioner is naming a line after four new heroes before the dust has settled. That is this city exactly. The adults at the table will feel it and the children will simply be delighted.\n\nWHAT COMES OF IT: drawers 401 to 404 at [[loc-sugar|the Sugar Vault]], one per hero, names on the brass, holding whatever they invented. He also has samples in the case and will hand them round while he writes.",
      "fields": {
        "looks": "Thirty-odd, green visor, sleeve garters, and mud to the knee that he has not once looked down at. A ledger open across both forearms, a pencil, and a flat wooden case of samples under one arm. His hands are always full, so he never offers to shake.",
        "wants": "To take the order correctly and get it written down exactly as it was said. Past that, for the ledger to balance, which it does.",
        ...
        "secret": "⚠ PROPOSED, NOT RULED. The Vault did not send him and the four drawers were his idea. He put it to the owner across the counter, the owner said do it if you like, and he has been rehearsing the wording ever since. He will not tell anybody this, and if the party ever gets it out of him it should cost him something to admit."
      }
    },
    {
      "schema": 1,
      ...
      "fieldDefs": [
        ...
        [
          "sunsalt",
          "What sunsalt is — the live thread"
        ],
        [
          "societies",
          "People still living in the Fold"
        ],
        [
          "open",
          "Undecided — Joby's"
      ...
      "fields": {
        ...
        "arrival": "JOBY'S: the first entry lands them in a SMALLER SPACE that soon opens into a MUCH LARGER one — a curved space big enough to hold an inner substructure the size of a mountain. THE SESSION ENDS AS THEY COME INTO THE INITIAL SMALL SPACE, so the great space is next time and none of the reveal is spent.\n\nTHE SMALL SPACE should be tight, unimpressive and clearly a service space rather than a grand hall — somewhere two faces nearly meet, or a landing on a stair running further up and down than the light reaches. Not built for them.\n\nTHE SOUND IS THE CLIFFHANGER, and it is free. The voices got louder and louder as the way opened; that is the entire reason they went in. THEY STEP THROUGH AND IT IS SILENT. They came for a sound and the sound is gone. Then, moving toward the opening at the far end, it comes back — not as voices but as REVERBERATION, with a delay so long it tells them the space beyond is miles across before they can see an inch of it. Stop there.\n\nALSO FROM THE BRAINSTORM, unused and available: nothing casts a shadow, because there is no sun in there and the light comes in through the gaps; the way back is visible from everywhere until they walk round something and it is not, because the cell is densely folded; and direction does not survive the crossing, so a party that went in as a line arrives in the wrong order.\n\n★ THE ENTRY ROOM IS NOW BUILT and runs as [[b-wreck-3|THE WAY IN, beat 3]]. It ends the evening sealed, silent and shadowless, with no way on and no way back that the party can find.\n\n★ THE WAY OUT IS A MINI PUZZLE, and it is the top of the NEXT session, never the end of this one. Ending on an unsolved puzzle is a miserable stop.\n\nTHE DESIGN, proposed and not yet built — two ideas and no more:\n· IT DEPENDS WHERE YOU STAND. The room looks sealed from every ordinary vantage. From one position — low down, lying on the floor, along the wall from the corner — there is plainly a seam. The lesson is LOOK AT IT FROM SOMEWHERE ELSE, which is the single most useful habit this campaign could teach them about the Fold. Needs a nudge available in case nobody thinks to get down.\n· IT WAS NOT BUILT FOR PEOPLE. The seam has a catch on it, and the catch is set at a height meant for something eight feet tall. Nothing is hidden and nothing is clever — it is simply out of reach, and they have to boost each other.\n\nRUN THEM TOGETHER: get down, find the seam, then somebody goes up on somebody's shoulders. Ten minutes, two ideas, both physical, no dice needed, and it ends with a nine-year-old standing on a fighter. It cannot be failed, only fumbled, which is funnier. It also IS the theme rather than illustrating it — they prove THIS WAS NOT MADE FOR US with their own arms.\n\nA THIRD IDEA, NOT CHOSEN and kept in case it is wanted: the room is a folded thing under tension and responds to where weight sits, so the seam opens while people stand on the right parts and shuts when they step off. Best for a party of four because everybody gets a station, and the good bit is the last person out — but it is the fiddliest to explain at the table.\n\nAND WHAT THE SEAM OPENS ONTO: the face, warm wind, the enormous space, a ledge road going down toward roofs, and the floating mass hanging out there unreachable. See the LAYOUT field.",
        ...
        "open": "· Whether the structure-is-the-Snarl reconciliation is adopted. Everything above assumes it.\n· WHERE THE TAKEN ARE KEPT — a FOLDED TOWN, occupied by goblins and other creatures, is Joby's pick and is the current direction. Why they were taken is leaning toward delivery to a buyer who extracts. Neither is settled.\n· DOES THE FOLDWRIGHT KNOW what sunsalt is, and what is his connection to it going back in? He bargained for limitless power through it, and canon says his moment of horror was about the RECIPIENT — so this would be a second, earlier ignorance, and whether he ever asked the price changes what kind of man sits at the center of this world.\n· WHO IS BUYING in the Fold. A new power, and a real commitment.\n· HOW MUCH THE PARTY LEARNS EARLY. The argument on the table is that in Act One they should see a room and not understand it.\n· How the memory effect is chosen and whether it wears off.\n· Whether the ship runs a fixed route, and who laid it.\n· Whether the tower built the line.\n· Whether the tower is in view from the town's streets the whole time.\n· What the floating mass actually is — a cell of swallowed country is the proposal, not a ruling.\n· The gray: the bible says the first lost place is partly gray. On the cell, presumably. Unconfirmed.",
        "sunsalt": "JOBY'S, AND IT IS THE BIGGEST IDEA ON THIS PAGE. Sunsalt is a UNIVERSAL FORCE — the energy of existence in raw form. It is not made of people and people are not its source. Humans are ONE source among many, and they deliver a particularly potent version of it. Humans are also NOT the source of the completed worlds' folding; that is a separate matter and this does not touch it.\n\nAND SOMEBODY IS EXTRACTING IT FROM PEOPLE, by ritual and by instrument. That is the buyer the goblins are delivering to.\n\nWHY IT IS NOT A RETROFIT. The bible has been holding a space for this. §8 Q17 asks what the deep floors do with the faded, and one of the three candidates already listed there is that their thinned threads are drawn off to sweeten the refining. THIS ANSWERS Q17 if adopted.\n\nWHAT IT SHARPENS, ALL OF IT ALREADY WRITTEN:\n· §7 RULE 12 — \"drawing it kills what it is drawn from, permanently, which is what makes the finale a genuine sacrifice.\" Currently reads as a fact about land. Stops being a metaphor.\n· THE GRAY — not pollution. A drained thing. Every fenced pocket outside Dunlath is somewhere something was taken out of, and the ministry calls it a blight with no author.\n· [[npc-hettie|HETTIE'S LEDGER]] — her Reactor intake never balances, and her quietest count is a census of the faded. THOSE ARE THE SAME CRIME and she is one line from seeing it. She has not, because nobody alive would believe her.\n· SCALE IS FINE, because sunsalt is universal and the ordinary supply comes from everywhere — the strata, the seams, the land. The world's lamps are not lit with people and never were.\n\n⚠ DO NOT OVER-APPLY THIS (Joby, 2026-09-04). Human-derived sunsalt is NOT a primary source and is not a component of the supply. It is rare to the point of legendary, it is used for SOMETHING ELSE, and what that something is has not been decided and does not need to be yet. Perhaps a little of it reaches potions and perhaps none of it does. It is a specific ingredient awaiting a specific application — do not let it colour the Lamp Office, the shelves at [[loc-bottles|Nine Hundred Bottles]], or anything else ordinary.\n· NO-DEATH HOLDS. Extraction FADES rather than kills, and the faded are canonically not dead and can be found.\n\nTHREE TWISTS WERE PUT UP AGAINST THE OBVIOUS VERSION. Joby is LEANING TOWARD THE THIRD.\n\n★ THREE — IT GOES BACK IN, and this is the one he wants. If sunsalt is the energy of existence in raw form then it can be RETURNED: a drawn person restored, dead gray land brought back to life. So the substance the world is being murdered for is also the only thing that can undo the murder — which turns the finale from a demolition into a real dilemma, and makes Red Flag's arithmetic much harder to hold, because unfolding the world costs them the only cure for what has already been taken. ➕ AND JOBY WANTS IT CONNECTED TO THE FOLDWRIGHT IN SOME WAY. Undesigned.\n\nONE — THE POTENCY IS NOT \"HUMAN\", IT IS UNFINISHED-NESS. What the salt is richest in is what a thing still meant to do, which is why a child yields more than somebody contented at the end of a long life, and why the Snatch took a seven-year-old at a fair. Rhymes hard with the cosmology, since the Fold's whole purpose is completion and a finished thing has nothing left in it. NOT CHOSEN, still available, and it costs nothing to add later.\n\nTWO — A LEGAL, HONORED, VOLUNTARY VERSION STANDS IN FRONT OF IT. Giving is a public good with a plaque at the Lamp Office and a stipend and a small ceremony, entirely sincere, and it accounts for a rounding error of supply. It kills the exposé plot: the party comes back with SUNSALT COMES FROM PEOPLE and the city says yes, my grandmother is on the plaque. NOT CHOSEN, still available, and it is the Surveyors' signature move applied in a new place.\n\nALREADY IN CANON AND VERY SHARP UNDER ANY OF THIS: the field still the party eventually builds leaves a palm-sized patch of gray wherever it is staked, and the bible says they will have left their own handprints across the world by the end. They are already complicit. There is eventually a night when the only fuel within reach is something alive, and that should be a real choice rather than a scripted fall.",
        "societies": "JOBY'S: there are small societies of people still alive inside the Fold, found later, and they bring WHOLE NEW WRINKLES to the justification and the motivation behind all of this. Undesigned and deliberately so.\n\nWHAT IS WORTH PROTECTING WHILE IT IS UNDESIGNED: these are people who have lived inside the thing the world outside cannot remember, which means they are the only humans anywhere with an unbroken account of what happened. Whatever they believe about sunsalt, extraction and the Fold will be first-hand, and it will not match Dunlath's story or Red Flag's.\n\nThey are the natural home for the arguments nobody outside is able to make.",
        "layout": "JOBY'S, FROM HIS OWN SKETCH. This is the shape of the first place, and it corrects an earlier assumption in this document that put the town on the floating mass.\n\n· THE ENTRY is a narrow slot high on a CLIFF FACE, and that face is the wall of the enormous space.\n· THE TOWN AND THE TOWER CLING TO THE FACE ITSELF, below and along from the entry — terraced into the wall, not standing on the floor of anything. The tower is at the top of the cluster.\n· THE FLOATING MASS hangs separately out in the space, mountain-sized, with a built and labyrinthine interior of its own.\n\nWHAT THAT GEOGRAPHY BUYS, and it is a great deal for free: THE TOWN IS WALKABLE AND THE MASS IS NOT. The party can reach the town on their own legs along the face. They cannot reach that thing hanging out there without a ship — so the ship stops being a nice idea and becomes a visible, unreachable promise from the first minute they step out onto the wall. They will look at it for a whole session before they can touch it.\n\nTHE ROUTE IS THEREFORE A LEDGE ROAD cut along the face, worn, going somewhere. Follow the ledge, reach the town. Better than the groove-in-the-floor idea it replaces, and the ship's line can run the same face with its berths at the town — so the road they trudge and the route they later ride are the same infrastructure at two scales.\n\n⚠ STILL OPEN: whether the tower looms over the town in view the whole time they are in it. The argument for yes is that they would be working directly under the answer to the object in their pocket and unable to reach it."
      }
    },
    {
      "schema": 1,
      "id": "b-wreck-3",
      "type": "beat",
      "title": "3 — Through: the room with no way out",
      "parent": "f-wreck",
      "order": 40,
      "rev": 2,
      "tags": [
      ...
      "body": "THE LAST TEN MINUTES OF THE EVENING, and the whole job of it is to put them INSIDE and stop.\n\nTHE CROSSING IS NOT AN EVENT. No rushing, no lights, no tunnel. One step, and they are standing somewhere else. Folding is a quiet, tidy, geometric operation and the Rectors' hands never hurry — nothing about this world suggests a vortex. The wrongness arrives a beat later, and it arrives as SILENCE.\n\nTHE SOUND IS THE POINT AND IT IS AN ABSENCE. The voices got louder and louder as the way opened, and that is the entire reason they went in. They step through and there is nothing. They came for a sound and the sound is gone. Let somebody say so.\n\n⚠ DO NOT RUN THE PUZZLE TONIGHT. The room has no exit and working out the way on is NEXT time. Ending an evening on an unsolved puzzle is a miserable stop; ending it on WE ARE IN A BOX is a very good one. See [[bb-fold|the back burner]] for how the way out is built.\n\n⚠ AND THE WAY BACK CANNOT BE FOUND EITHER, which is what makes the room feel sealed. The order is still holding it open and has not betrayed anybody — it is simply that looking straight at a way is difficult from the outside and impossible from in here, so nothing shows on the wall they came through. Do not explain this and do not let anybody confirm it. The party does not know whether it is still there.\n\n⚠ THE MEMORY EFFECT IS DUE HERE AND IT IS NOT DESIGNED. Every entry into the Fold carries a possibility of one; the first entry is meant to carry two, and both are on [[bb-fold|the back burner]]. Decide BEFORE you run this whether it fires tonight as the last thing that happens, or at the top of the next session. Firing it tonight is a far bigger stop and it hands a player a hard job with no warning.",
      "fields": {
        "hook": "Every single person who has spoken to them about this place has said the same thing in slightly different words: nobody knows what is in there, because nobody has come back. They are in there now. It is a small room that was not built for people, and it is completely silent.",
        "read_aloud": "\"There is no rushing and there is no falling and there is nothing to see on the way. You step, and you are standing somewhere else, and the somewhere else is warm.\n\nAnd it is silent.\n\nThe voices are gone. Not faint — gone. You came in here because you could hear them and you cannot hear anything at all.\n\nYou are in a room, and the room is small. Cut stone, or something enough like it. There is a step up along one side, and it comes to about your chest. There is a doorway in the wall opposite, and it is narrow enough that you would have to turn sideways, and it is easily twice as tall as any of you, and it is filled in solid.\n\nThe light is coming from no particular direction and there is a great deal of it, and it takes a moment before somebody works out what is wrong with it.\n\nNothing in here is casting a shadow. Not the step. Not the walls. Not you.\"",
        "env": "• THE FIRST SECOND — no transition of any kind. One step and they are standing. Let a player be the one to say that nothing happened.\n• SILENCE — total, and it is the change everybody at the table will feel, because the sound was the argument for coming.\n• WARM, and the air smells faintly of somewhere outdoors, which it should not, because this is a sealed room.\n• THE LIGHT — plenty of it, from no direction, and NOTHING CASTS A SHADOW. Give them a moment to notice before anybody says it.\n• THE SIZES ARE WRONG — a step up at chest height, a doorway twice as tall as a person and too narrow to walk through facing forward. Nobody explains it and nobody has to. It says THIS WAS NOT MADE FOR YOU in about four seconds.\n• THE DOORWAY IS FILLED IN. Not blocked, not rubble — the wall simply continues through where the opening is.\n• THE WALL THEY CAME THROUGH — blank. Nothing on it, nothing in the air in front of it, no seam, no shimmer.\n• IN THEIR ORDER — whoever went first is not necessarily standing at the front. Direction did not survive the crossing.",
        "if_they": "…look for the way back, they do not find it, and that should be played straight and without cruelty. There is nothing on that wall. The order is still out there holding it open and nobody in this room can know that.\n\n…shout, or call back through, nothing answers and the sound goes nowhere. It does not echo. In a stone room it should.\n\n…search the room properly, they find that it is very well made and completely sealed, and that everything in it is the wrong size. That is the whole of what tonight gives them, and it is enough.\n\n…try [[enc-ganny|the object]] on the walls, let them. It behaves exactly as it did in the chamber under the cellar: warmth, a flicker, and nothing. It is not the answer here either.\n\n…listen for the voices, there is nothing, and there is nothing every time they try. The sound comes back later and not tonight.\n\n…panic, let them, and do not rescue them from it. Nobody is in danger in this room and that is what makes it frightening.\n\n…ask what they are supposed to do now, that is the correct question and it is where the evening ends.",
        "outcome": "STOP HERE. They are inside the Fold, in a sealed room built for something much taller, with no way on and no way back that they can find, and the sound they came for is gone.\n\nNEXT TIME opens with them working the way out. The layout beyond it — the cliff face, the ledge road, the town and tower on the wall, and the floating mass out in the space — is on [[bb-fold|the back burner]] and is not built yet."
      }
    },
    {
      "schema": 1,
      "id": "npc-ganny",
      "type": "npc",
      "title": "Ganny Marle — the woman with the fake hole",
      "parent": "f-npcs",
      "order": 90,
      "rev": 1,
      "tags": [
      ...
      "leadsTo": [],
      "fieldDefs": null,
      "body": "Eighty years old, in a good hat, running a swindle out of her own cellar — and the first person in this campaign to ask the party for something rather than give them something.\n\nWHERE SHE APPEARS. She crosses the fairground at dusk in [[b-comm-dusk|THE COMMISSION beat 2]] and asks them to come that night. The night itself is [[enc-ganny|under her cellar]]. The place, the swindle and the tunnels are on [[loc-ganny|her location sheet]], and her secret is on that sheet's HIDDEN field rather than repeated here, so that the two cannot drift apart.\n\nHOW TO RUN HER, AND IT IS ALL IN ONE TRICK: SHE HAS TWO VOICES. The first is the patter — nineteen years of standing at the top of six steps taking a penny off strangers, and it is warm, practiced, funny and completely hollow. The second is what is left when she stops performing, and it is flat, brief and much older. THE MOMENT SHE SWITCHES IS THE ONLY SIGNAL SHE EVER GIVES, and she gives it three times: when she says she came down to look at the big one, when she asks them to come tonight, and when somebody holds up a jar of preserves with the wrong handwriting on the label.\n\nSHE ASSESSES PEOPLE AND DOES NOT HIDE IT. She looks the party over the way somebody prices a horse. She is not being rude; she is deciding whether four armed strangers are worth the risk, and she decides yes.\n\nWHAT SHE MUST NOT DO IN ACT ONE: confess, recruit, explain, or make a case for anything. She is not a believer and she does not preach — [[npc-hettie|Hettie Sarn]] is the one who puts the argument. Ganny is infrastructure who happens to be lovable, and the party should leave her cellar certain she knew more than she said and unable to prove a word of it.\n\nSHE IS NOT A COMBATANT and she is in the chamber during the fight, on the wrong side of it, and cannot get up the ladder quickly. That is deliberate — see [[enc-ganny|the encounter]].",
      "fields": {
        "looks": "Eighty, small, and dressed better than the house. The hat is genuinely good and she is aware of it. She goes down a dark ladder without needing to look at her feet, which is the first thing about her that does not add up.",
        "wants": "The thing in her cellar gone, tonight, without anybody official ever hearing about it — and that is the whole of what she will say she wants. What she actually needs is for her road to stay open, and she cannot say that to anybody.",
        "voice": "The patter, until it is not. Warm, quick, practiced, and full of a showman's cheerful nonsense — and then it drops, mid-sentence, into something flat and brief, and then it comes back. She is not a good liar and she has never needed to be one, because nobody has ever asked her a serious question.",
        "secret": "On [[loc-ganny|her location sheet]], in the HIDDEN field, along with the three reasons she cannot ask her own people for help. It is not repeated here on purpose: one true copy, pointed at from everywhere else.\n\nThe short version for a DM who needs it mid-sentence: SHE IS RED FLAG, she is a courier node rather than a believer, the tunnels under her cellar are the underground's road, and the crease down there is a separate matter that her people wanted and the goblins reached first."
      }
    },
    {
      "schema": 1,
      "id": "loc-registry",
      "type": "location",
      "title": "The Registry — where everything is written down",
      "parent": "f-locations",
      "order": 25,
      "rev": 1,
      "tags": [
      ...
      "body": "WHAT IT IS, IN ONE LINE: the human-staffed office that records what crossed a road, what came down a Reactor, and who was standing nearby. The Surveyors prefer human hands for human paperwork, so the whole of it is staffed by clerks.\n\nWHY IT MATTERS TO THE PARTY, AND IT IS THE THING THAT KEEPS GETTING MENTIONED WITHOUT BEING EXPLAINED. Three separate threads run through this building and none of them has had a home until now.\n· IT IS [[npc-tobin|TOBIN RELL]]'S EMPLOYER. The Accord's right of search says no expedition enters the creases without a Registry clerk to keep the record, which is why the party is given a man rather than asked whether they want one.\n· IT IS WHERE THE CRIER SENT THE WHOLE CITY. Anyone with knowledge of Red Flag is to present themselves here, and there is a reward — so on the morning after the fair there is a queue out the door of people with something to say about their neighbors.\n· IT IS AN ENORMOUS SEARCHABLE RECORD, and the party has a writ. This is the best investigative resource in Dunlath and nobody has told them it exists.\n\n⚠ AND EVERY QUESTION THEY ASK IS WRITTEN DOWN WITH THEIR NAME ON IT. Not as a trap and not as a trick — it is simply what this building does to everything, including itself. Do not warn them and do not have anybody warn them.\n\nTHE REGISTRY IS NOT SINISTER AND SHOULD NEVER BE PLAYED AS SINISTER. It is the most honest institution in the city: it writes down what happened, accurately, and gives it to whoever is entitled to ask. That is precisely what makes it dangerous, and the party will not feel that for a long time.\n\n[[loc-petition|The Petition Rail]] is the brass rail outside this building, which is where a person who is not entitled to ask goes instead.",
      "fields": {
        "looks": "Long, low and human. Where the government quarter is FOLDED — creases up every façade, nothing jointed, nothing carried there — this was BUILT, out of brick, by people, with mortar lines you can put a fingernail in. It is the plainest important building in Dunlath and it is the only one in the quarter that looks like work.\n\nInside: a hall of counters that runs further than it should, clerks at every one of them, and behind the clerks the shelving, going up three floors of galleries and back into the dark. Ladders on rails. The sound is paper and pens and low voices, all day.\n\nOutside, under a canvas awning, [[loc-petition|the Petition Rail]], polished by a lifetime of hands.\n\n⚠ THE BUILT-NOT-FOLDED CONTRAST IS PROPOSED, not ruled. It is a good detail and it costs nothing, but it is an invention.",
        "who_is_here": "Clerks. Hundreds of them, and every single one is human. Nobody here is important and everybody here is busy, and they are helpful in the specific way of people who like their filing system and are pleased to be asked about it.\n\nON THE MORNING AFTER THE FAIR there is also a queue, and it is long, and it is made of people who have come to say something about a neighbor and collect a reward. Play it without comment. Some of them are frightened, some are certain, and one or two are enjoying themselves.",
        "ask": "THE RULE: if it crossed a road, came down a tower, or happened where somebody was standing, it is in here. A writ gets it looked up. There is no roll — the answer is a clerk, a ladder, and a wait.\n\nWHAT IT WILL ANSWER\n· What crossed a given road on a given day, and who was on the gate.\n· Who was standing nearby when something happened, because faces get written down.\n· What came down out of a Reactor, in what quantity, signed for by whom.\n· Where a wagon went, if it went by road.\n· Who lives at an address, who used to, and when that changed.\n\nWHAT IT WILL NOT ANSWER, and always for the same reason — not secrecy, but that it was never written down here\n· Anything that happened inside a crease.\n· Anything the order did on its own account. The Surveyors do not file with the Registry; the Registry files for them.\n· Anything a Rector has marked, which a clerk will tell them plainly and without embarrassment.\n\nWHAT IT COSTS: nothing, and a wait, and a line in a ledger with their names on it.",
        "hidden": "[[npc-tobin|TOBIN FILES HERE NIGHTLY]], to an office upstairs that [[npc-wenna|Wenna]] has never dealt with and does not know exists. He is honest in both directions and that is the whole of the problem.\n\n⚠ OPEN, AND WORTH DECIDING BEFORE THE PARTY EVER COMES LOOKING: who reads those filings. [[unans-index|THE BOARD]] refers to a clerk at a third desk who is deliberately kept offstage. Whether that clerk is a person, a post, or a Surveyor wearing a coat is not settled.\n\nTHE THREE REMOVED PAGES from the [[loc-ossuary|Keystone]]'s register would have been copied here, because everything is. Nobody has thought to look."
      }
    }
  ]
};
