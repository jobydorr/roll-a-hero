...
window.DM_CAMPAIGN = {
  ...
  { "schema": 1, "id": "loc-index", "type": "note",
    ...
    "parent": "f-locations", "order": 10, "rev": 2,
    ...
    "fields": {
      ...
      "state": "The city is DUNLATH, and it is a WEALTHY one — this world was folded for plenty and the occupation's whole case rests on having delivered it. Play the district as comfortable and well-fed: good coats, lamps in every window, nobody hungry. The pressure in Act One is not poverty, it is that a rich city has just met its first limit in living memory and has no idea how to behave.\n\nIt is the week after Lastlight. The Cinder Draw was formally closed with garlands, so the best-paid trade in the world ended on a Tuesday and nobody has a job. Eleven people are officially missing and everyone who was there knows the number is wrong. The price of a lamp has doubled. The town overhead hangs where it has always hung."
    },
  ...
  { "schema": 1, "id": "loc-lampoffice", "type": "location",
    ...
    "parent": "f-locations", "order": 40, "rev": 2,
    ...
    "fields": {
      ...
      "who_is_here": "Well-dressed people queuing for the first time in their lives and being extremely gracious about it in a way that is worse than shouting, and a clerk doing his best who has been graciously spoken to nine times today.",
  ...
  { "schema": 1, "id": "loc-rationhall", "type": "location",
    "title": "The Hearth — where the city draws its due",
    "parent": "f-locations", "order": 70, "rev": 2,
    "tags": ["city", "registry", "affluence"], "leadsTo": [],
    "fields": {
      "looks": "The grandest building on the street and the busiest: a marble arcade under a glass roof, with potted trees down the middle, brass everywhere, and a board at the far end that clatters over every few minutes with household numbers being called. Along the sides are counters for provisions, for cloth, for boots, for fuel, for furniture, and at the back, past a screen of ferns, a bath house and an infirmary with good surgeons in it and no queue worth the name.\n\nNothing here costs anything. Nobody calls it charity, because it is not presented as charity: every household in Dunlath has an ACCOUNT, an account is a right rather than a favor, and drawing on it is the ordinary business of a Tuesday.",
      "who_is_here": "Everybody, in their good coats. People dress to come here — it is somewhere to be seen, and there is a slow promenade up the middle of the arcade that nobody will admit is a promenade. Uniformed attendants in green work the floor, and they are relentless: an attendant will take a parcel out of your hands whether or not you want them to, and will carry it to your door, and will not be argued out of it.",
      "hidden": "The account is a file. Every draw, every yard of cloth, every visit to the infirmary is entered under a name with a date, openly and in front of the person concerned, because an auditable record is exactly what makes the fairness real. It is the most honest institution in the city and it holds a complete history of everyone in it."
    },
    "body": "WHAT THEY DO HERE. Get healed, fed, clothed and equipped for nothing, in comfort, without shame and without a queue. Take it. It is real, it is generous, and the campaign is not interested in punishing anyone for using it.\n\nTHE JOKE, and it lands from the doorway: THE PARTY WILL NOT BE PERMITTED TO CARRY ANYTHING. Attendants take things out of their hands mid-sentence. Refuse, and a second attendant is summoned to help with the difficulty. Leave, and three of them follow the party down the street carrying their shopping, at a respectful distance, indefinitely. This is very funny for about four minutes and then quietly stops being funny, which is the whole occupation in one gag.\n\nWHAT IT COSTS. Their injuries are on a file with dates, and so is every time they turned up hurt. Nothing comes of this in Act One. It comes up in Act Two, when somebody produces the dates and asks where they were.\n\nWHY IT MATTERS NOW. This is why [[npc-tobin|Tobin]]'s hands are worth more than they look. A party that works out on its own that it would rather not be written down has understood the occupation better than a speech could teach them — and they will have worked it out inside a beautiful building that was nothing but kind to them.\n\n⚠ OPEN QUESTION FOR JOBY. How this world's economy actually works is undecided: universal plenty administered as a right, or a wealthy market society with supports dressed up as service. The Hearth is deliberately written to read as either, and nobody in Dunlath could tell you which it is. Settle it when it matters; nothing here has to change first." },
