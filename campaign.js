...
window.DM_CAMPAIGN = {
  ...
  "docs": [
    ...
    },
    {
      ...
      "body": "THIS IS THE CLIFFHANGER and it does not need dressing up. Four people who could not save a boy at that tower are walking into the place he went, on purpose, because they can hear him.\n\nPLAY THE OPENING AS A COURTESY, not a ritual. Nobody chants. It is four polite beings doing an eight-second piece of work for some young people they think very highly of, and the horror is entirely in how normal it is for them.\n\n★ THE ONE THING TO GET RIGHT HERE IS THE OBJECT IN ITS HAND. If the party has been under [[loc-ganny|Ganny's cellar]] they are carrying something that looks very like it, taken off a goblin, which does not work for them. Put it in the description once, low and unremarked, and then leave it entirely alone. The players do the work. What they conclude is theirs.\n\n⚠ THIS DOES CHANGE THE BEAT AS IT WAS FIRST WRITTEN, where the opening was bare hands and nothing else. It is still not a ritual and there is still nothing anybody could copy — there is now a tool in it, and the party has one.\n\nDO NOT LET ANYONE SAY WHAT IS ON THE OTHER SIDE, including the party once they are through. It opens the next time you sit down.",
      "schema": 1,
      "rev": 5,
      "leadsTo": [],
      "fieldDefs": [
